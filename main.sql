...
CREATE TABLE `ysk_agent` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='代理表';
...
CREATE TABLE `ysk_bankcard` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='银行卡管理';
...
CREATE TABLE `ysk_menu` (
  ...
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=563 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `ysk_recharge` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=87 DEFAULT CHARSET=utf8 COMMENT='会员充值表';
...
CREATE TABLE `ysk_roborder` (
  ...
  PRIMARY KEY (`id`),
  KEY `class` (`class`,`price`,`addtime`),
  KEY `status` (`status`,`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=356 DEFAULT CHARSET=utf8 COMMENT='抢单表';
...
CREATE TABLE `ysk_somebill` (
  ...
  PRIMARY KEY (`id`),
  KEY `jc_class` (`jc_class`)
) ENGINE=MyISAM AUTO_INCREMENT=360 DEFAULT CHARSET=utf8 COMMENT='会员流水账单';
...
INSERT INTO `ysk_user` VALUES ('71', '2', '0', '0', '13112345611', '13112345611', 'fA0dw4he', '13112345611', '1e90728d00535d574ec46e2d9d703d80', '9536', '100000000.00', '1564920869', '', '1', '0', '72biu5td0lvt3peeec1hc89j01', '1', '1', '1', '3319277666@qq.com', '3319277666', '350681198409152222', null, '0', '0', '1', '0', '0.00', '0', '66666', '1', '0');
...
INSERT INTO `ysk_user` VALUES ('118', '0', '0', '0', '3113123424', '3113123424', 'q7hgbPt22Cb9', '3113123424', '80821d8b9cbef221794e1a6f1054ec38', '7279', '100000000.00', '1568043392', '', '1', '0', null, '', '', '', '', '', '', null, '0', '0', '1', '1', '0.00', '1', '0', null, '0');
...
INSERT INTO `ysk_user` VALUES ('207', '165', '0', '0', '13333615970', '13333615970', 'lou3zXfe7WBD', '罗天', 'a264423bed543ae5bf74069af1b984bd', '0MxQ', '0.00', '1578319936', '42.232.94.123', '1', '0', '2lql7enfejgledfr4me7omc074', null, null, null, '', '', '', '-165-', '1', '0', '1', '1', '0.00', '0', '10', '0', '0');
...
) ENGINE=MyISAM AUTO_INCREMENT=137 DEFAULT CHARSET=utf8 COMMENT='会员抢单表前台发起的';
...
CREATE TABLE `ysk_withdraw` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='提现申请表';
