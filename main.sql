...
-- ----------------------------
INSERT INTO `ysk_agent` VALUES (1, 'shh001', 'e10adc3949ba59abbe56e057f20f883e', 1, 1582357884, '10.168.1.132', 1785, 1582357890, 0, '工行', '建设路 支行', '李天一', '111000999', 'admin', 'PSK3A8AHLP6CP3ES1X63MJN1JQR8R9OF', 2, 2, 2, 9818.92, '');
...
INSERT INTO `ysk_agent` VALUES (6, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1, 1563611747, '127.0.0.1', 10, 1587616553, 0, NULL, NULL, NULL, NULL, 'admin.1111', '000000', 3, 2, 3, 0.00, '');
...
INSERT INTO `ysk_user` VALUES (1, 0, 0, 0, '13100000000', '13100000000', '', '13100000000', '9672e6c05f3b6eecdb57ab2358a9bd05', '3156', 5885.73, 1560570334, '', 1, 0, '5dn8rgub6kjb08lkd1inbl7h82', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 40.50, 1, 0, 1, 1, '');
...
INSERT INTO `ysk_user` VALUES (169, 165, 0, 0, '18928696507', '18928696507', 'jIeS31UR8VwL', '陈超威', 'b58352a7e5e3b914c94e7e5917ec949c', 'be1q', 0.00, 1577859401, '113.70.210.192', 1, 0, 'etvoh8pbo184sd8324e566i483', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, '');
...
CREATE TABLE `z_log`  (
  ...
  `addtime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1822 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
