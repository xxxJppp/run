...
CREATE TABLE `ysk_admin`  (
  ...
  `reg_type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '注册人',
  `is_open_google_auth` tinyint(1) NULL DEFAULT 0,
  `google_auth` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `username`(`username`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台管理员表格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ysk_admin
-- ----------------------------
INSERT INTO `ysk_admin` VALUES (5, 1, 'admin', 'admin', '8f3bd6b4d00391c9d09cc14e32fee28c', '13111111111', 1911986758, 1571910396, 1587364169, 1, NULL, 0, '');
...
CREATE TABLE `ysk_agent`  (
  ...
  `names` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '代理用户名',
  `pwd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '代理登录密码',
  `zt` tinyint(3) NULL DEFAULT 1 COMMENT '账号是否启用：0=停用 1=启用',
  `addtime` int(11) NULL DEFAULT 0 COMMENT '开通时间',
  `ip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属ip',
  `login_num` int(11) NULL DEFAULT 0 COMMENT '登录次数',
  `last_time` int(11) NULL DEFAULT 0 COMMENT '最后一次登录',
  `pid` int(11) NULL DEFAULT 0 COMMENT '上级ID',
  `bankname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `bankinfo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `wx` float NULL DEFAULT 0,
  `zfb` float NULL DEFAULT 0,
  `sjm` float NULL DEFAULT 0,
  `money` decimal(10, 2) NULL DEFAULT 0,
  `is_open_google_auth` tinyint(1) NULL DEFAULT 0,
  `google_auth` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 33 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ysk_agent
-- ----------------------------
INSERT INTO `ysk_agent` VALUES (1, 'shh001', 'e10adc3949ba59abbe56e057f20f883e', 1, 1582357884, '10.168.1.132', 1785, 1582357890, 0, '工行', '建设路 支行', '李天一', '111000999', 'admin', 'PSK3A8AHLP6CP3ES1X63MJN1JQR8R9OF', 2, 2, 2, 9818.92, 0, '');
INSERT INTO `ysk_agent` VALUES (2, 'shh002', 'e10adc3949ba59abbe56e057f20f883e', 1, 1560590181, '112.207.3.180', 1, 1567759579, 0, NULL, NULL, NULL, NULL, 'ceshi001.com', 'A8NYX3H381D3S9APXN64EMWIQ0SDP1I8', 2.8, 2.6, 1.2, 972.00, 0, '');
INSERT INTO `ysk_agent` VALUES (3, '', 'e10adc3949ba59abbe56e057f20f883e', 1, 1563019042, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, 'admin', '', 0, 0, 0, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (4, 'jiejie0595', 'e10adc3949ba59abbe56e057f20f883e', 1, 1563532599, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, 'admin', 'aa112233', 0.1, 0.1, 0.1, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (5, '13599217309', 'e10adc3949ba59abbe56e057f20f883e', 1, 1563533124, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '13599217309', '112233', 0.1, 0.1, 0.1, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (6, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1, 1563611747, '127.0.0.1', 10, 1587616553, 0, NULL, NULL, NULL, NULL, 'admin.1111', '000000', 3, 2, 3, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (7, '123110', 'e10adc3949ba59abbe56e057f20f883e', 1, 1563611790, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, 'admin.1111', 'B49RO1CLC6OF6YW3FA2LOC26GS9KEE3U', 3, 3, 3, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (8, '123', 'e10adc3949ba59abbe56e057f20f883e', 1, 1563612893, '113.65.231.17', 1, 1563612950, 0, NULL, NULL, NULL, NULL, 'admin', 'Y826ZSY7QAMTJ1UT16G7QV8IWEFX0QED', 10, 10, 10, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (9, '123321', 'd41d8cd98f00b204e9800998ecf8427e', 1, 1563679378, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '', '', 0, 0, 0, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (10, 'shanghu111', '3d186804534370c3c817db0563f0e461', 1, 1563719319, '123.161.217.215', 1, 1563719257, 0, '123', '123', '213', '123', 'v.pptv.com/show/fwP9e3sDC0msKpI.htm', 'YVR8CYLYZFLFUMGEIKA87DINLCPR8IG3', 1, 2, 3, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (11, '大发', 'e10adc3949ba59abbe56e057f20f883e', 1, 1563954416, '36.106.21.23', 1, 1563954480, 0, '', '', '', '', '', '6JS33XTCVF31K3QC4MXP8D2CIV68UTMZ', 4, 3.5, 2.5, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (12, '000002', 'e10adc3949ba59abbe56e057f20f883e', 1, 1564393540, '223.157.89.63', 2, 1564408932, 0, '建设银行', 'XX公司', '哈利油', '147258369', '', 'N8JN2B0RK0P8ZICNADI8Q6SBN1CH1VA8', 1, 1, 1, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (14, '521', 'c7b3802ebc4755d0b61e5db8c94e6bf4', 1, 1564504591, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '', 'wjy123', 3, 5, 2, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (15, '54645', 'e10adc3949ba59abbe56e057f20f883e', 1, 1564537805, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '562525.com', 'AD0WF5OOP3B53BAYBYWQ9YUNBOPCSEYU', 3, 3, 3, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (16, 'qazwsx', '7e7576bde8baa58874dc2a8a752ee3dc', 1, 1564541426, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '13599217309', '1U3YOBW7I2MUYAXXN4Y7DKTMYNNN2HHA', 1, 1, 1, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (17, 'azsxdc', 'e10adc3949ba59abbe56e057f20f883e', 1, 1564544816, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '772855984@qq.com', 'YJ8EHPPREQWJQMG0NFA6UAKLPYUFE3Y3', 1, 1, 1, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (22, 'aa123456', 'dc483e80a7a0bd9ef71d8cf973673924', 1, 1566639122, '121.31.246.4', 1, 1566639133, 0, '', '', '', '', 'www.cp8899.site', 'U5HYKIV39JVG9XQ7NXIAB5XHA31IL5JI', 0, 0, 0, 3541.00, 0, '');
INSERT INTO `ysk_agent` VALUES (21, 'ceshi', '44cf9833462ab54740bfb915b36d2733', 1, 1566191239, '222.212.6.25', 1, 1566191472, 0, NULL, NULL, NULL, NULL, 'www.baidu.com', 'VT1ZMJUFHC4QSNA4OCROEAV3T1WAPVDA', 0.1, 0.1, 0.1, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (23, '刘明一', 'd7077e0ccfe69607e3cb290ce61c811d', 1, 1566628896, '117.183.8.43', 1, 1566629631, 0, NULL, NULL, NULL, NULL, '', 'J2SOEPRP7EDJMW3RA7I419HDBLG2MZRT', 1.3, 1.3, 1.3, 0.99, 0, '');
INSERT INTO `ysk_agent` VALUES (24, 'xxceshi', 'e10adc3949ba59abbe56e057f20f883e', 1, 1566805015, '42.226.116.200', 1, 1566805042, 0, NULL, NULL, NULL, NULL, 'baidu.com', 'JVJSGK1RHUSI51L9ROMLLM5Z2GY1GOKD', 1.5, 1.5, 1.5, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (25, '龙龙', '36ed58c5c14dc2f58eef099585d2a939', 1, 1567059418, '117.183.8.43', 1, 1566994332, 0, '', '', '', '', '', 'LKAEB41GBCR499MHHURQIBM4H7Y1R1Y8', 0, 2, 2, 500.00, 0, '');
INSERT INTO `ysk_agent` VALUES (26, 'ZHUYI', '1dfc269f9a745a95802a4af561764115', 1, 1570124151, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, 'https://s.taobao.com/search?q=%E8%B7%91%E5%88%86', 'MX0NXFXJ8QURY3S7MUBFGXEABP9PO6B7', 2, 2, 2, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (27, '111', 'e10adc3949ba59abbe56e057f20f883e', 1, 1571381333, '117.181.81.112', 1, 1571381542, 0, NULL, NULL, NULL, NULL, '13100000000', 'RUD85ZL5XF15Y91SSJ7WM1Q045875SAJ', 1, 0.1, 0.1, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (28, 'gghun1', 'c8837b23ff8aaa8a2dde915473ce0991', 1, 1571392634, NULL, 0, 0, 0, '', '', '', '', '112233', 'GCZ3YYJO9GCNWQQAVD1QL40M3MWKWFAY', 0, 0, 0, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (29, 'ddss667788', 'e10adc3949ba59abbe56e057f20f883e', 1, 1571531393, NULL, 0, 0, 0, '', '', '', '', '13100000000', 'HKPWGBNHWE4PYMK6X8O37QVPMFGIDJNA', 0, 0, 0, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (30, '222', 'e10adc3949ba59abbe56e057f20f883e', 1, 1577977529, '115.53.107.121', 1, 1577977535, 0, '', '', '', '', 'www.99t.com', 'BE47DWAC05N16Y84YR58L88GP2FMJAGF', 1.2, 1.2, 1.5, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (31, 'ceshishangjia1', 'e10adc3949ba59abbe56e057f20f883e', 0, 1577890466, '1.198.29.29', 1, 1575121381, 0, '', '', '', '', 'http://api.gnqtl.xyz/api1', 'P7Q94UXOR56LVE8II23IPXSWL9SYMLEF', 1.2, 1.2, 1.2, 0.00, 0, '');
INSERT INTO `ysk_agent` VALUES (32, 'merchant', 'e10adc3949ba59abbe56e057f20f883e', 1, 1587530898, '127.0.0.1', 7, 1587622779, 0, NULL, NULL, NULL, NULL, '', '', 0, 0, 0, 0.00, 0, '');
...
CREATE TABLE `ysk_bankcard`  (
  ...
  `name` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '持卡人',
  `bankname` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '所属银行',
  `banknum` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '银行卡号',
  `addtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 36 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '银行卡管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_complaint`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NULL DEFAULT NULL COMMENT '投诉人id',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '投诉内容',
  `imgs` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片路径',
  `status` tinyint(1) NULL DEFAULT 0 COMMENT '0 未查看 1 已查看',
  `create_time` int(10) NULL DEFAULT NULL COMMENT '投诉时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投诉建议表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 45 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_ewm`  (
  ...
  `ewm_url` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '二维码地址',
  `ewm_price` float(10, 2) NOT NULL COMMENT '二维码收款金额',
  `ewm_acc` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '二维码账号',
  `uaccount` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户账号',
  `uname` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名',
  `addtime` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '添加时间',
  `gengxintime` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `jdtime` int(10) NULL DEFAULT 0,
  `zt` int(10) NULL DEFAULT 1,
  `zt1` int(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uid`(`uid`, `ewm_class`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 134 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '二维码管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_group`  (
  ...
  `hylb` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '部门信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_menu`  (
  ...
  `col` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '控制器',
  `act` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '方法',
  `patch` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '全路径',
  `level` int(11) NOT NULL COMMENT '级别',
  `icon` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sort` char(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '排序',
  `status` tinyint(3) NOT NULL DEFAULT 0 COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 564 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_news`  (
  ...
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文章图片',
  ...
  `from` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文章来源',
  `visit` smallint(6) NOT NULL DEFAULT 0,
  `lang` tinyint(4) NOT NULL DEFAULT 0,
  `tuijian` tinyint(4) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统公告' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_notice`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `notice_tittle` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公告标题',
  `notice_content` varchar(600) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公告详情',
  `notice_addtime` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公告添加时间',
  `notice_read` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '看过公告会员',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ysk_qrcode`  (
  ...
  `uname` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '会员名称',
  `code_class` int(2) NOT NULL COMMENT '二维码类型1支付宝2微信3银行卡',
  `code_url` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '二维码图片地址',
  `uaccount` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '会员账号',
  `code_acc` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '二维码账号，如支付宝账号',
  `addtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '二维码管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_recharge`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `uid` int(11) NOT NULL COMMENT '会员ID',
  `account` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '会员账号',
  `name` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '姓名',
  `price` float(10, 2) NOT NULL COMMENT '充值金额',
  `way` int(11) NOT NULL COMMENT '充值方式：1支付宝2微信3银行卡',
  `addtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '充值日期',
  `status` int(11) NOT NULL COMMENT '充值状态1提交，2退回，3成功',
  `marker` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '备注',
  `pic` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '凭证',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 87 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员充值表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ysk_recharge` VALUES (86, 169, '18928696507', '陈超威', 10000.00, 3, '1578856563', 1, '中国建设银行', '');
...
CREATE TABLE `ysk_roborder`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `idewm` int(11) NULL DEFAULT NULL COMMENT '匹配二维码id',
  ...
  `uname` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '匹配用户名称',
  `umoney` float(10, 2) NOT NULL COMMENT '匹配用户余额',
  `pipeitime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '匹配时间',
  `finishtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '完成时间',
  `ordernum` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单号',
  `class2` int(11) NULL DEFAULT NULL,
  `ip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `shanghu_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `zduid` int(11) NULL DEFAULT NULL COMMENT '指定单',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `class`(`class`, `price`, `addtime`) USING BTREE,
  INDEX `status`(`status`, `uid`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 356 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '抢单表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ysk_roborder
-- ----------------------------
INSERT INTO `ysk_roborder` VALUES (204, NULL, 1, 0.00, '1575966061', 2, 9, '15566667777', 524.50, '1575966061', '', 'N080163910709', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (203, NULL, 1, 0.00, '1575966060', 2, 9, '15566667777', 524.50, '1575966060', '', 'N080163910709', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (202, NULL, 1, 0.00, '1575966059', 2, 9, '15566667777', 524.50, '1575966059', '', 'N080163910709', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (198, 95, 1, 500.00, '1575887790', 3, 9, '56700000', 24.50, '1575887930', '', 'E15758877851077', NULL, '103.137.63.190', 'shh002', NULL);
INSERT INTO `ysk_roborder` VALUES (199, NULL, 1, 0.00, '1575966056', 2, 9, '15566667777', 524.50, '1575966056', '', 'N080163910709', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (200, NULL, 1, 0.00, '1575966057', 2, 9, '15566667777', 524.50, '1575966057', '', 'N080163910709', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (201, NULL, 1, 0.00, '1575966058', 2, 9, '15566667777', 524.50, '1575966058', '', 'N080163910709', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (188, NULL, 2, 0.00, '1575737919', 2, 159, '13931091933', 98022.00, '1575737919', '', 'N513463935322', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (189, NULL, 2, 0.00, '1575737928', 2, 159, '13931091933', 98022.00, '1575737928', '', 'N513463935322', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (182, 92, 2, 10000.00, '1575296459', 3, 152, '王时尚', 2581.05, '1575296589', '', 'N958899380943', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (183, 93, 2, 10000.00, '1575296459', 3, 155, 'As', 3745.40, '1575296475', '', 'N958899380943', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (184, NULL, 2, 0.00, '1575303608', 2, 159, '13931091933', 19629.50, '1575303608', '', 'N824529841547', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (181, 90, 2, 10000.00, '1575296459', 3, 156, '1', 6030.00, '1575296812', '', 'N958899380943', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (196, 95, 1, 500.00, '1575887350', 3, 9, '56700000', 16.00, '1575887384', '', 'E15758873482276', NULL, '58.57.39.236', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (177, 92, 2, 100.00, '1575294905', 3, 152, '王时尚', 2627.20, '1575295363', '', 'N008023427277', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (178, 92, 2, 100.00, '1575294905', 3, 152, '王时尚', 2725.70, '1575294927', '', 'N008023427277', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (176, 92, 2, 100.00, '1575294905', 3, 152, '王时尚', 2528.70, '1575295892', '', 'N008023427277', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (175, 93, 2, 100.00, '1575294905', 3, 155, 'As', 3743.90, '1575296256', '', 'N008023427277', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (174, 92, 2, 100.00, '1575294905', 2, 152, '13111112222', 2758.05, '1575297395', '', 'N008023427277', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (173, 94, 2, 100.00, '1575294905', 3, 156, '1', 6081.50, '1578045913', '', 'N008023427277', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (171, 85, 2, 100.00, '1575294905', 2, 9, '15566667777', 1000.00, '1575431209', '', 'N008023427277', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (195, 95, 1, 500.00, '1575886927', 3, 9, '56700000', 508.50, '1575887300', '', 'E15758869243156', NULL, '58.57.39.236', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (170, 85, 2, 100.00, '1575294905', 2, 9, '15566667777', 1000.00, '1575364667', '', 'N008023427277', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (167, 92, 2, 1000.00, '1575294093', 3, 152, '王时尚', 2810.70, '1575294671', '', 'N881764183372', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (168, 91, 2, 1000.00, '1575294093', 3, 1, '', 5765.44, '1575294181', '', 'N881764183372', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (166, 86, 2, 1000.00, '1575294093', 3, 159, '', 18629.50, '1575303581', '', 'N881764183372', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (169, 90, 2, 100.00, '1575294905', 3, 156, '1', 6080.00, '1575297453', '', 'N008023427277', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (139, 85, 2, 100.00, '1574928276', 3, 9, '56700000', 95134.57, '1574943983', '', 'N408660869886', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (140, 86, 2, 200.00, '1575002761', 3, 159, '', 6015.50, '1575002777', '', 'N023791160203', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (141, 86, 2, 200.00, '1575002761', 3, 159, '', 5817.50, '1575002838', '', 'N023791160203', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (142, 86, 2, 200.00, '1575002761', 3, 159, '', 5619.50, '1575002995', '', 'N023791160203', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (143, 86, 2, 300.00, '1575003047', 3, 159, '', 5221.50, '1575003401', '', 'N109067989069', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (144, 86, 2, 300.00, '1575003047', 3, 159, '', 4924.50, '1575003459', '', 'N109067989069', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (145, 85, 2, 300.00, '1575003047', 2, 9, '15566667777', 95135.57, '1575011432', '', 'N109067989069', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (146, 86, 2, 300.00, '1575003047', 2, 159, '13931091933', 1027.50, '1575018691', '', 'N109067989069', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (147, 85, 2, 300.00, '1575003047', 2, 9, '15566667777', 94838.57, '1575018289', '', 'N109067989069', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (148, 85, 2, 300.00, '1575011475', 3, 9, '56700000', 94835.57, '1575013189', '', 'N293306150044', NULL, NULL, NULL, 9);
INSERT INTO `ysk_roborder` VALUES (149, 86, 2, 900.00, '1575019217', 3, 159, '', 127.50, '1575019243', '', 'N518617975266', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (151, 85, 2, 500.00, '1575122004', 2, 9, '15566667777', 94838.57, '1575162866', '', 'E15751220029183', NULL, '1.198.29.29', 'ceshishangjia1', NULL);
INSERT INTO `ysk_roborder` VALUES (152, 86, 2, 1000.00, '1575261341', 3, 159, '', 1137.50, '1575261375', '', 'N555316056669', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (153, 86, 2, 1000.00, '1575261341', 3, 159, '', 147.50, '1575261432', '', 'N555316056669', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (154, 86, 2, 1000.00, '1575261341', 3, 159, '', 1058.50, '1575270367', '', 'N555316056669', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (155, 85, 2, 1000.00, '1575261341', 3, 9, '56700000', 93838.57, '1575276021', '', 'N555316056669', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (156, 86, 2, 1000.00, '1575261341', 2, 159, '13931091933', 1109.50, '1575276066', '', 'N555316056669', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (159, 86, 2, 4000.00, '1575271779', 3, 159, '', 1069.50, '1575271792', '', 'N067202184675', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (160, 86, 2, 1000.00, '1575277236', 3, 159, '', 16514.50, '1575293822', '', 'N291543218524', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (161, 93, 2, 1200.00, '1575291497', 3, 155, 'As', 3825.90, '1575296082', '', 'N690919360450', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (194, 95, 1, 500.00, '1575886712', 3, 9, '56700000', 500.00, '1575886862', '', 'E15758867096396', NULL, '58.57.39.236', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (164, 93, 2, 1000.00, '1575294093', 3, 155, 'As', 2895.40, '1575296668', '', 'N881764183372', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (165, 86, 2, 1000.00, '1575294093', 3, 159, '', 97022.00, '1575311032', '', 'N881764183372', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (205, NULL, 1, 0.00, '1575966062', 2, 9, '15566667777', 524.50, '1575966062', '', 'N080163910709', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (206, NULL, 1, 0.00, '1575966064', 2, 9, '15566667777', 524.50, '1575966064', '', 'N080163910709', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (207, NULL, 1, 0.00, '1575966065', 3, 9, '56700000', 32.00, '1576006869', '', 'N080163910709', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (209, 96, 1, 1000.00, '1576066562', 3, 164, '张磊', 9000.00, '1576068910', '', 'N666502582464', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (210, 96, 1, 1000.15, '1576068997', 3, 164, '张磊', 8014.85, '1576069063', '', 'N902479199491', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (211, 96, 1, 500.00, '1576069184', 3, 164, '张磊', 7544.85, '1576069194', '', 'N513394259180', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (212, 96, 1, 1000.13, '1576069321', 3, 164, '张磊', 6559.72, '1576069337', '', 'N185423050755', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (243, 97, 2, 500.00, '1576732784', 3, 9, '56700000', 9081.50, '1576732897', '', 'E15767327827598', NULL, '36.34.29.92', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (230, 95, 1, 500.00, '1576731812', 3, 9, '56700000', 9566.50, '1576732053', '', 'E15767318102742', NULL, '36.34.29.92', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (244, 95, 1, 5000.00, '1576733086', 3, 9, '56700000', 763.50, '1576733118', '', 'N345807357629', NULL, NULL, NULL, 9);
INSERT INTO `ysk_roborder` VALUES (245, 97, 2, 1.00, '1576733163', 3, 9, '56700000', 177032.41, '1578045884', '', 'E15767331625108', NULL, '36.34.29.92', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (259, 98, 2, 500.00, '1576733621', 2, 9, '15566667777', 112075.50, '1576733840', '', 'E15767335934271', NULL, '36.34.29.92', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (260, 97, 2, 500.00, '1576735106', 3, 9, '56700000', 191400.50, '1576747082', '', 'E15767351058537', NULL, '36.34.29.92', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (269, 98, 2, 500.00, '1576762604', 2, 9, '15566667777', 190915.50, '1576762606', '', 'E15767626037253', NULL, '36.34.28.135', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (268, 97, 2, 500.00, '1576758881', 2, 9, '15566667777', 191415.50, '1576761140', '', 'E15767588801690', NULL, '36.34.28.135', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (279, 97, 2, 500.00, '1576779843', 3, 9, '56700000', 190415.50, '1576820902', '', 'E15767798411628', NULL, '36.34.28.135', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (280, 98, 2, 500.00, '1577455605', 3, 9, '56700000', 177526.91, '1578045866', '', 'E15774556023730', NULL, '115.53.104.202', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (282, 103, 2, 500.00, '1577890427', 3, 171, '', 501.00, '1577929159', '', 'E15778904233362', NULL, '115.53.67.180', 'shh001', NULL);
INSERT INTO `ysk_roborder` VALUES (284, 106, 3, 2000.00, '1577976415', 3, 165, '', 28000.00, '1577976462', '', 'N192884671792', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (286, NULL, 3, 0.00, '1577976511', 2, 165, '14725836900', 30000.00, '1577976511', '', 'N243224867838', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (287, 106, 3, 2000.00, '1577976584', 3, 165, '', 26020.00, '1577976606', '', 'N923733761342', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (288, NULL, 3, 0.00, '1577976673', 2, 165, '14725836900', 30000.00, '1577976673', '', 'N243224867838', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (289, 99, 3, 10000.00, '1577977043', 2, 9, '15566667777', 190430.50, '1577977047', '', 'N713415154236', NULL, NULL, NULL, 9);
INSERT INTO `ysk_roborder` VALUES (290, NULL, 3, 0.00, '1577977106', 2, 9, '15566667777', 190430.50, '1577977106', '', 'N276463817000', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (291, NULL, 3, 0.00, '1577977147', 2, 9, '15566667777', 190430.50, '1577977147', '', 'N276463817000', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (292, NULL, 3, 0.00, '1577977194', 2, 9, '15566667777', 190430.50, '1577977194', '', 'N276463817000', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (299, 109, 3, 2000.00, '1577978675', 3, 165, '', 24040.00, '1578012639', '', 'N785576694388', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (294, 106, 3, 10000.00, '1577977398', 2, 165, '14725836900', 26040.00, '1577977411', '', 'N008824784745', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (295, 100, 3, 10000.00, '1577977426', 2, 9, '15566667777', 180430.50, '1577977468', '', 'N160820079821', NULL, NULL, NULL, 9);
INSERT INTO `ysk_roborder` VALUES (296, NULL, 3, 0.00, '1577977609', 3, 9, '56700000', 180430.50, '1577977650', '', 'N496775261031', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (297, NULL, 3, 0.00, '1577977615', 2, 165, '14725836900', 26040.00, '1577977615', '', 'N203031086675', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (298, 100, 3, 10000.00, '1577977718', 3, 9, '56700000', 170530.50, '1577977728', '', 'N555769532297', NULL, NULL, NULL, 9);
INSERT INTO `ysk_roborder` VALUES (300, 100, 3, 3000.00, '1577978760', 3, 9, '56700000', 177680.50, '1577978775', '', 'N992906686706', NULL, NULL, NULL, 9);
INSERT INTO `ysk_roborder` VALUES (301, 109, 3, 10000.00, '1578016141', 3, 165, '', 14070.00, '1578016166', '', 'N855415491647', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (302, 109, 3, 3000.00, '1578016240', 3, 165, '', 11220.00, '1578016255', '', 'N168439070202', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (303, 109, 3, 5000.00, '1578016274', 3, 165, '', 6265.00, '1578016292', '', 'N218979350751', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (304, 95, 1, 100.00, '1578017386', 3, 9, '56700000', 177625.50, '1578017400', '', 'N085456447568', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (306, 109, 3, 2500.00, '1578017533', 3, 165, '', 3840.00, '1578018369', '', 'N552462446647', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (307, 109, 3, 2500.00, '1578017578', 3, 165, '', 1377.50, '1578018381', '', 'N472540809532', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (308, 109, 3, 10000.00, '1578026822', 3, 165, '', 91415.00, '1578027266', '', 'N808862424535', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (309, 101, 1, 350.00, '1578027349', 2, 166, '陈冬明', 501.00, '1578027557', '', 'N489270169329', NULL, NULL, NULL, 166);
INSERT INTO `ysk_roborder` VALUES (310, NULL, 1, 0.00, '1578027684', 3, 166, '', 151.00, '1578027688', '', 'N545175041604', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (311, 109, 3, 8000.00, '1578027722', 3, 165, '', 83566.47, '1578027750', '', 'N803312486644', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (312, 109, 3, 12000.00, '1578027744', 3, 165, '', 71686.47, '1578027764', '', 'N017737359555', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (313, 109, 3, 9500.00, '1578027758', 3, 165, '', 62366.47, '1578028672', '', 'N756647462778', NULL, NULL, NULL, 165);
INSERT INTO `ysk_roborder` VALUES (314, 109, 3, 10000.00, '1578027822', 3, 165, '', 52508.97, '1578028687', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (315, 109, 3, 10000.00, '1578027822', 3, 165, '', 42658.97, '1578028779', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (316, 109, 3, 10000.00, '1578027822', 3, 165, '', 32808.97, '1578028793', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (317, 109, 3, 10000.00, '1578027822', 3, 165, '', 22958.97, '1578028805', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (318, 109, 3, 10000.00, '1578027822', 3, 165, '', 13108.97, '1578029141', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (319, 109, 3, 10000.00, '1578027822', 3, 165, '', 43410.67, '1578043016', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (320, 109, 3, 10000.00, '1578027822', 3, 165, '', 33560.67, '1578043035', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (321, 100, 3, 10000.00, '1578027822', 3, 9, '56700000', 167131.42, '1578047939', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (322, 100, 3, 10000.00, '1578027822', 2, 9, '15566667777', 167281.42, '1578047944', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (323, 100, 3, 10000.00, '1578027822', 2, 9, '15566667777', 167281.42, '1578302042', '', 'N587721382716', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (324, 115, 1, 3500.00, '1578027846', 2, 179, '余晨曦', 5001.00, '1578028548', '', 'N925049230786', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (325, 116, 1, 3500.00, '1578027846', 2, 179, '余晨曦', 5001.00, '1578028868', '', 'N925049230786', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (326, 117, 1, 3500.00, '1578027846', 3, 165, '', 9758.97, '1578030408', '', 'N925049230786', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (327, 117, 1, 5000.00, '1578027862', 3, 165, '', 4807.97, '1578030420', '', 'N463680259578', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (328, 109, 3, 4500.00, '1578030828', 3, 165, '', 21626.17, '1578043157', '', 'N810348302983', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (329, 100, 3, 8500.00, '1578030841', 2, 9, '15566667777', 167281.42, '1579085206', '', 'N997188653735', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (330, 109, 3, 8500.00, '1578030841', 3, 165, '', 13193.67, '1578044401', '', 'N997188653735', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (331, 117, 1, 1500.00, '1578030857', 3, 165, '', 3389.67, '1578040970', '', 'N486015351237', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (332, 109, 3, 7700.00, '1578030869', 3, 165, '', 26010.67, '1578043075', '', 'N365341959467', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (333, 100, 3, 10000.00, '1578031269', 2, 9, '15566667777', 167281.42, '1579278749', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (334, 100, 3, 10000.00, '1578031269', 2, 9, '15566667777', 167281.42, '1579279150', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (335, 126, 3, 10000.00, '1578031269', 2, 9, '15566667777', 157281.42, '1579279161', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (336, 100, 3, 10000.00, '1578031269', 2, 9, '15566667777', 157281.42, '1579368932', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (337, 100, 3, 10000.00, '1578031269', 2, 9, '15566667777', 147281.42, '1579413246', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (338, 126, 3, 10000.00, '1578031269', 3, 9, '56700000', 127281.42, '1579413267', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (339, 100, 3, 10000.00, '1578031269', 2, 9, '15566667777', 137431.42, '1579427243', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (340, 100, 3, 10000.00, '1578031269', 2, 9, '15566667777', 137431.42, '1579584611', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (341, 100, 3, 10000.00, '1578031269', 2, 9, '15566667777', 137431.42, '1579634027', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (342, 126, 3, 10000.00, '1578031269', 2, 9, '15566667777', 147281.42, '1579368943', '', 'N895504489999', NULL, NULL, NULL, NULL);
INSERT INTO `ysk_roborder` VALUES (343, 119, 3, 700.00, '1578031401', 3, 172, '', 301.00, '1578031789', '', 'N891855167816', NULL, NULL, NULL, 172);
INSERT INTO `ysk_roborder` VALUES (344, 119, 3, 900.00, '1578032397', 3, 172, '', 412.50, '1578032525', '', 'N772066746751', NULL, NULL, NULL, 172);
INSERT INTO `ysk_roborder` VALUES (345, NULL, 3, 3000.00, '1578032543', 1, 0, '', 0.00, '', '', 'N395879974572', NULL, NULL, NULL, 172);
INSERT INTO `ysk_roborder` VALUES (346, NULL, 3, 3000.00, '1578032553', 1, 0, '', 0.00, '', '', 'N860212597155', NULL, NULL, NULL, 172);
INSERT INTO `ysk_roborder` VALUES (347, NULL, 3, 5000.00, '1578032564', 1, 0, '', 0.00, '', '', 'N250083685607', NULL, NULL, NULL, 172);
INSERT INTO `ysk_roborder` VALUES (348, NULL, 3, 5000.00, '1578032574', 1, 0, '', 0.00, '', '', 'N120161250284', NULL, NULL, NULL, 172);
INSERT INTO `ysk_roborder` VALUES (349, NULL, 3, 2000.00, '1578032584', 1, 0, '', 0.00, '', '', 'N392643087180', NULL, NULL, NULL, 172);
INSERT INTO `ysk_roborder` VALUES (350, 119, 3, 500.00, '1578033156', 3, 172, '', 927.00, '1578033253', '', 'N241482595936', NULL, NULL, NULL, 172);
INSERT INTO `ysk_roborder` VALUES (351, 119, 3, 500.00, '1578034004', 3, 172, '', 434.50, '1578034129', '', 'N490521744878', NULL, NULL, NULL, 172);
INSERT INTO `ysk_roborder` VALUES (352, 123, 3, 5000.00, '1578045998', 3, 193, '', 1.00, '1578317016', '', 'N103610514613', NULL, NULL, NULL, 193);
INSERT INTO `ysk_roborder` VALUES (353, 123, 3, 5000.00, '1578047450', 2, 193, '秦守博', 5001.00, '1578048285', '', 'N995136209522', NULL, NULL, NULL, 193);
INSERT INTO `ysk_roborder` VALUES (354, 128, 3, 3000.00, '1578317002', 3, 199, '', 0.00, '1578317555', '', 'N702094962345', NULL, NULL, NULL, 199);
INSERT INTO `ysk_roborder` VALUES (355, 128, 3, 2500.00, '1578318795', 3, 199, '', 500.00, '1578318944', '', 'N005415200054', NULL, NULL, NULL, 199);
...
CREATE TABLE `ysk_skm`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `wxewm` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `zfbewm` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `bankewm` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收款码' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_somebill`  (
  ...
  `info` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '说明',
  `addtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '事件时间',
  `jc_class` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分+ 或-',
  `num` float(10, 2) NOT NULL COMMENT '币量',
  `xjuid` int(10) NULL DEFAULT NULL COMMENT '来自谁的提成',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `jc_class`(`jc_class`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 360 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员流水账单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_store`  (
  ...
  `cangku_num` decimal(13, 5) NOT NULL DEFAULT 0 COMMENT '钱包余额',
  `fengmi_num` decimal(13, 5) NOT NULL DEFAULT 0 COMMENT '积分',
  `plant_num` decimal(13, 4) NOT NULL DEFAULT 0 COMMENT '播种总数',
  `huafei_total` decimal(13, 2) UNSIGNED NOT NULL DEFAULT 0 COMMENT '施肥累计',
  `vip_grade` tinyint(1) NULL DEFAULT 0,
...
CREATE TABLE `ysk_system`  (
  ...
  `jdtime` int(10) NULL DEFAULT NULL,
  `qd_sq` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `qd_cf` int(11) NOT NULL COMMENT '抢单余额比列',
  `qd_nd` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '抢单难度，数组(0.1,0.2,0.3)',
  ...
  `qd_ndtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '增加难度时间点',
  `qd_yjjc` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '佣金加成',
  ...
  `cz_yh` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cz_xm` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cz_kh` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `wxb` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `zfbb` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ylb` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ed` decimal(10, 2) NULL DEFAULT 0,
  `qd_kf` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '游戏参数设置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_tixian`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shanghu_id` int(11) NULL DEFAULT NULL,
  `shanghu_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `shanghu_kahao` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `shanghu_huming` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `shanghu_yinhang` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `shanghu_xinxi` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `money` decimal(10, 2) NULL DEFAULT 0,
  `addtime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `zt` int(11) NULL DEFAULT 0 COMMENT '0未审核 1 已审核 2错误',
...
CREATE TABLE `ysk_upload`  (
  ...
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件上传表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_user`  (
  ...
  `account` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '用户账号',
  `mobile` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户手机号',
  `u_yqm` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '邀请码',
  ...
  `money` float(10, 2) NOT NULL DEFAULT 0 COMMENT '用户余额',
  `reg_date` int(11) NOT NULL COMMENT '注册时间',
  `reg_ip` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '注册IP',
  ...
  `session_id` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `wx_no` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信账号',
  `alipay` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付宝',
  `truename` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '真实姓名',
  `email` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '电子邮件',
  `userqq` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'QQ',
  `usercard` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '身份证号码',
  ...
  `agent` int(11) NULL DEFAULT 0,
  `num` int(11) NULL DEFAULT 10,
  `zdopention` int(11) NULL DEFAULT NULL,
...
-- Records of ysk_user
-- ----------------------------
INSERT INTO `ysk_user` VALUES (85, 0, 0, 0, '15970603995', '15970603995', 'SbPYwHVv9vgU', '15970603995', 'd81ed3d8efe67f7c93e9cb05a19f5105', '5117', 0.00, 1565076795, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (3, 2, 0, 0, 'dfdsfds', '13456789009', '4hse45h5', 'dfdsfds', '2184bf64e5e696123baf7d6425e77ef5', '2770', 0.00, 1560502602, '', 1, 0, NULL, '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 0, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (7, 0, 0, 0, '15511090417', '15511090417', '', '15511090417', 'd403b68b77860b5f1f698130505138d8', '3560', 0.02, 1560571836, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 5, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (1, 0, 0, 0, '13100000000', '13100000000', '', '13100000000', '9672e6c05f3b6eecdb57ab2358a9bd05', '3156', 5885.73, 1560570334, '', 1, 0, '5dn8rgub6kjb08lkd1inbl7h82', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 40.50, 1, 0, 1, 1, 0, '');
INSERT INTO `ysk_user` VALUES (6, 0, 0, 0, '18321631857', '18321631857', '', '18321631857', '332e51c8f2ab46a377349260ade0f2e0', '370', 0.00, 1560570862, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (8, 0, 0, 0, '13913124650', '13913124650', '', '13913124650', '698fd40f639b46efd8e4edfbd83831c3', '7183', 0.00, 1560572618, '', 1, 0, 'jit5sa70kor4428gde29dtsp14', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (9, 0, 0, 0, '13800138000', '13800138000', '4534dfdfg', '15566667777', '041fa50fcfc633d6f5401fc548a11798', '7774', 137431.42, 1560579763, '', 1, 0, '710fmoh3s67l7qgnciqdssdhl7', '567', '567', '56700000', '2342@qq.com', '567', '567', NULL, 0, 8, 1, 1, 707694.69, 1, 9999, 1, 24, 0, '');
INSERT INTO `ysk_user` VALUES (10, 2, 0, 0, '13333333333', '13333333333', 'fw54AhhD', '13333333333', '964f45954424fb2bc430411fe27ec971', '2707', 0.00, 1560584639, '', 1, 0, '1fk4vuh53hpe9g2u9nqiqnv1d1', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 0, NULL, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (11, 0, 0, 0, '18000000000', '18000000000', '', '18000000000', '77c05d2a6fcde573ffe3a68a61fd5443', '4738', 100000.00, 1560586188, '', 1, 0, '1q017j3qlekgc31butbcupcog2', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (56, 0, 0, 0, 'adminww', 'adminww', 'LuBysh2E01tB', 'adminww', '0b86cbdc28fcca0b2435dad67036ef9e', '9657', 10000000.00, 1564447325, '', 1, 0, NULL, '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (13, 12, 0, 0, '闫振龙', '18625824723', 'wBhDeFDh', '闫振龙', '749ea9c2e4f5fb5b76fdde1a1d902afe', '2443', 0.00, 1560590474, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (14, 2, 0, 0, 'whfes01', '19999999999', 'EFD140Cs', 'whfes01', 'ed744537809431da10caaf89991bb7bf', '6535', 0.00, 1560592506, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (62, 54, 0, 0, '胡小小', '15196672529', 'Ce45h400', '胡小小', '646fcd78176167d8c9d5805e220822d9', '2835', 0.00, 1564710832, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (16, 0, 0, 0, '18960238701', '18960238701', '', '18960238701', '70b2020a606735c34dedd04bf3d9038f', '1027', 0.00, 1560602161, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 0, 0.00, 1, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (17, 2, 0, 0, 'djfjds', '13567896789', 'Bh54C4Fh', 'djfjds', '5d7df6959beb5e42de65cff9c3ccd6d8', '4875', 8016.00, 1560657291, '', 1, 0, 'hvl5br8alvbp2qcgfj3ruapse6', '34', '34', 'dfds', 'dfdsf@dsf.com', '234324', '3432432', NULL, 0, 1, 1, 1, 16.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (18, 17, 2, 0, '13456789000', '13456789000', 'OLYqLpVJ28Iv', 'erwe', '149dd2de7d927a793945671245002279', 'TY8c', 0.00, 1560658942, '127.0.0.1', 1, 0, NULL, NULL, NULL, NULL, '', '', '', '-17-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (77, 0, 0, 0, '18723888888', '18723888888', 'ceZXzzEmBsjE', '13112345611', 'eda1d542fab7a37327e2550e22f34e59', '343', 0.00, 1564993062, '', 1, 0, 'j2parrbtm94sl5sg1nt0hh5hh4', 'chenchen20190401', '18396290177', '陈梅香', '', '', '', NULL, 0, 0, 1, 0, 0.00, 1, 1000, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (20, 0, 0, 0, '13252585458', '13252585458', '', '13252585458', 'dc4a26ce0b136b40a0f02335a71f46c5', '5281', 0.00, 1563149840, '', 1, 0, 'mc50krcg13svskashs1dbh6iv3', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (21, 1, 1, 1, '13888888888', '13888888888', 'OYeKVKTqDObq', '13033556688', '8afc14645ed885190bfbb0ce23334b6b', 'f0f', 23097.60, 1563163346, '14.106.121.50', 1, 0, 'qdle1jde2tvoo3j0gomibcus43', '456456', '456456', '谢', '456456@qq.com', '456456', '4564564546546456', '--', 1, 1, 1, 1, 808.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (22, 0, 0, 0, '13245674567', '13245674567', 'ey261pbEIiUD', '13245674567', '96ca78c6286c56002a4748343a3ec7c6', '4907', 5000.00, 1563245021, '', 1, 0, '66bc90a3l8ap66a004menc53h1', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (23, 1, 0, 0, '15637897332', '15637897332', 'rI6BMa453syO', '张旭', 'a91225a8bbe6f46bd5ed8a12c7f124d6', 'ZNDK', 0.00, 1563254320, '61.158.152.20', 0, 0, 'id5a4lno1sbbsd9ajaqg2l6ie1', '', '', '', '', '', '', '-196-1-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (24, 0, 0, 0, 'momo624', 'momo624', 'evMfpkbMX3YZ', 'momo624', '54fefe6a8dcfc185d7ad9d11485eaa51', '6421', 0.00, 1563444962, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (27, 0, 0, 0, '13599217309', '13599217309', 'SYL88d6AzoaS', '13599217309', '520191a5af5473475d04058ee366a7b2', '8396', 0.00, 1563532779, '', 1, 0, 'v42v2l6ghu8ove68k6edagka62', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (28, 0, 0, 0, '1256744534', '1256744534', 'ZMTCwgdWobUZ', '1256744534', '14cc7b6019a4449f4a35871c5f56df3c', '1425', 0.00, 1563551675, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (32, 0, 0, 0, '16666666666', '16666666666', 'VeNrSeNDMwwW', '16666666666', 'fd8fa02fdbf86e2e72f86240d1ed02b6', '8960', 1500.00, 1563804071, '', 1, 0, '559iao25aft84ovf6j550e28q5', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (31, 0, 0, 0, '15555555555', '15555555555', '2n0fUWnOcPQZ', '15555555555', 'ad38ff20d62df28081d7f7e5f2f06138', '167', 0.00, 1563760407, '', 1, 0, 's35dk6kdlvhoh59cn40i0b5vh5', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (33, 0, 0, 0, '1870608', '1870608', 'hRdFFzHeBSQ6', '1870608', '5c3f83ce904a20d5f61e9ef03eb0b63e', '8095', 3210.40, 1563861223, '', 1, 0, '9e5v6t51lg5oamnef2btdju2v4', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 22.40, 1, NULL, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (34, 0, 0, 0, '13212312312', '13212312312', 'WPGhMddC8TIZ', '13212312312', '46b8525f34b0ea0534addff4778f2f23', '8346', 0.01, 1563892909, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (35, 34, 0, 0, '10086', '10086', '14DC05D1', '10086', '62dc4d6b70f423510b56742ab3d918f8', '3651', 9901.20, 1563894023, '', 1, 0, 'vkh1res5kps2jd75u0s1les095', '123456456', '23151', '测试', '132156151@qq.com', '256165165', '132151', NULL, 0, 0, 1, 1, 1.20, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (36, 0, 0, 0, '18666666666', '18666666666', 'atPOdZU0KrcS', '18666666666', '4266c1ace426c0ab69502f8e51ac24ad', '7417', 2000.00, 1563935183, '', 1, 0, 'gko43ls051fhi199or7mm9rc25', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (40, 0, 0, 0, '17777777777', '17777777777', '6q15h4zLUz4X', '17777777777', 'f71cf94ccc82d0f987eb8598aa34790a', '1543', 17059.50, 1564129394, '', 1, 0, 'nf4c373dbi1q6l8glapkbmpad2', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 2.50, 1, NULL, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (39, 1, 0, 0, '18831173823', '18831173823', 'DnERTpsZySlU', '18831173823', '3e9b86eff66198f8dfd8131249faf958', 'Ikg2', 0.00, 1564069265, '106.117.77.155', 0, 0, 'dielbmo6k0e2456hi39enuljn3', NULL, NULL, NULL, '', '', '', '-196-1-', 1, 0, 0, 0, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (38, 37, 0, 0, '1008611', '1231561', '05hDw4DF', '1008611', '7769648c25021e30019d997b8f6331f7', '1444', 9902.50, 1563994919, '', 1, 0, 'udadmcp7rdhn24cr1k1icjvid6', '234234', '234234', '34234', '23543@qq.com', '4534', '24323', NULL, 0, 0, 1, 1, 2.50, 0, 50000, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (41, 0, 0, 0, '13566778800', '13566778808', '1Wpq3Hz4PHgr', '13566778808', 'a165d251f30df1f63be056da32f481bf', '5631', 0.00, 1564141563, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (49, 48, 47, 0, '13866666666', '13866666666', 'LNJWpAcOhI2r', 'we', '30fe5f219ff09da95bfff4bbeed85014', 'ibEA', 10500.00, 1564313857, '113.247.47.64', 1, 0, 'lbqq0lh08egfrmudbgpjlhjke5', '123', '12321312', '2313', 'sds@126.com', '1516546', '14545646456', '-47-48-', 1, 0, 1, 1, 500.00, 0, 0, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (43, 0, 0, 0, '12345678901', '12345678901', 'A5NrpwDkWHAI', '12345678901', '7a41812865281521299fe6905004c1f2', '3380', 0.00, 1564241011, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (44, 43, 0, 0, 'love2019', '13888888866', 'B1jA4eD5', 'love2019', '1fb5ca27c412ec20942581286c9dcf6a', '1035', 0.00, 1564244063, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 0, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (45, 2, 0, 0, '123456789', '12345678910', '15DhA04f', '123456789', '765b7afe4bc158d1a7148bee744ead6c', '9389', 15.72, 1564306407, '', 1, 0, 'kba40lupu1ss5jbdag2k81j8j4', '423423', '142342314', '3242314', '2343324@qq.com', '23423', '13242314', NULL, 0, 0, 1, 1, 12.52, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (46, 0, 0, 0, 'zbh123456', 'zbh123456', '4BCXPiwocaoo', 'zbh123456', '50436088a35ae95609cad12cf3651178', '1600', 0.00, 1564312590, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (47, 0, 0, 0, '1234567', '1234567', 'DVFKxDUfbGT5', '1234567', 'e79b3ab8fc02cb953221ffc732ba4191', '7008', 5354.26, 1564312722, '', 1, 0, 'j2parrbtm94sl5sg1nt0hh5hh4', NULL, NULL, NULL, '', '', '', NULL, 0, 1, 1, 1, 0.02, 1, NULL, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (48, 47, 0, 0, '13888886666', '13888886666', 'dEqXKrwPjcK3', 'foryou', '57359bc6c453bd23ede28470e5540330', 'SydI', 480130.00, 1564312842, '113.247.47.64', 1, 0, 'kc8ui452kiqtvo2cbkri1slg45', '2312', '3123', '11', 'dwjikd@126.com', '1561561563', '416841564156', '-47-', 1, 1, 1, 1, 356.00, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (55, 0, 0, 0, '000001', '000001', 'pVUf6i8EO9hV', '000001', 'd15b29548e04cbb253b3f8d15073b2e7', '9150', 0.00, 1564384722, '', 1, 0, '7tmkq0g9pd9u1akttbeja8cul2', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (50, 31, 0, 0, '13200132000', '13200132000', 'C4j14SDh', '13200132000', 'cf69571d4fcb39309d9f98a9ebf8c135', '6911', 0.00, 1564370554, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (51, 33, 0, 0, '13300133000', '13300133000', 'DhD14eB4', '13300133000', 'bc4d39e7a261839759a622def40cae22', '5691', 0.00, 1564370771, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (52, 35, 0, 0, '15900159000', '15900159000', 'D04sBSA1', '15900159000', 'e292d3b975e397225aac7b21f5e1a15a', '2778', 100000.00, 1564371935, '', 1, 0, 'a355ui7toformtpn185j2235m3', '', '', '', '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (53, 47, 0, 0, '13455667766', '13455667766', '1hD0e40F', '13455667766', '57e263b731bce41082b70aca44f625d8', '7321', 0.00, 1564383604, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (54, 47, 0, 0, '123111144512', '123111144512', 'e01dEshA', '123111144512', '74590d4b9a5c828797ab69c02d720045', '800', 0.00, 1564383925, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (57, 1, 0, 0, '15926772119', '15926772119', 't49eB7Ey41bo', '小陈', '13c4a0404923cb20c0caab5cf3e69086', 'vNPJ', 88885360.00, 1564507289, '119.123.35.56', 1, 0, '72biu5td0lvt3peeec1hc89j01', '15926772119', '15926772119', '小陈', '15926772119@qq.com', '15926772119', '15926772119', '-196-1-', 1, 0, 1, 1, 44.41, 0, 999, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (58, 1, 0, 0, '18715207085', '18715207085', 'vtVkvct5txVK', 'azsxqw', '6b2c062e5f8eceda861ae18a01339814', '0dk8', 0.00, 1564545285, '117.136.103.172', 1, 0, NULL, NULL, NULL, NULL, '', '', '', '-196-1-', 1, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (59, 1, 0, 0, '18839290613', '18839290613', '6gJ3GusCRk7f', '李帅', '5a57dd86fee6a0751dcfb5a268d76489', 'ohbZ', 0.00, 1564550366, '120.216.173.75', 1, 0, 'hi0u4or9bo8i52loikk48357s3', NULL, NULL, NULL, '', '', '', '-196-1-', 1, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (60, 53, 0, 0, '18180461101', '18180461101', 'Fjd4s1Bf', '18180461101', '2ed6085ebcb63f179ef1d174062d89ed', '5069', 0.00, 1564560439, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (63, 54, 0, 0, 'test', '13388886666', '50FD1hAD', 'test', 'c35eea6b59119e220be2db401937d268', '5739', 0.00, 1564711829, '', 1, 0, NULL, '', '', '', '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (61, 56, 0, 0, '12345665432', '12345665432', 'hsh5401h', '12345665432', '005bc597af2919828086079e8395384b', '6319', 48800.08, 1564586009, '', 1, 0, '72biu5td0lvt3peeec1hc89j01', 'w po h xin k', '我陪你', '想起', '734943496@qq.com', '97349465', '3794389767946946464956', NULL, 0, 0, 1, 1, 8.08, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (64, 1, 0, 0, '13598999347', '13598999347', 'Do6ofCTl9KKu', '1287677886', '8eca3688505a94acd91fc6bd03673d9c', '6Nph', 200.00, 1564746122, '61.158.149.169', 1, 0, 'r4rihh63m2npemugskb351epr1', '1287677886', '13598999347', '陈小东', '1512861809@qq.com', '1512861809', '411081199503228544', '-196-1-', 1, 0, 1, 0, 400.00, 0, 20, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (65, 0, 0, 0, '13859674037', '13859674037', 'fvBdhEGtzwwv', '13859674037', 'ae17a0a49cb6da7847eee4e22fb0857e', '7762', 0.00, 1564800597, '', 1, 0, 'pm8c1ar3qfe40apiii23fve3v7', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (68, 2, 0, 0, '156710004444', '156710004444', 'DBs44A0A', '156710004444', '114a6488abfb58922796faa3039b2f18', '4797', 39620.66, 1564900970, '', 1, 0, '1pfh56aaj9fppi48ndu8sr6dq0', '小颜', '小颜', '小颜', '78524628@qq.com', '425875268', '4258842288566588', NULL, 0, 1, 1, 1, 136.65, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (66, 0, 0, 0, '13333337777', '13333337777', 'K5wFHBjKTiI1', '13333337777', '17a23bf6315624671f1fe4ccff48bfc4', '5275', 0.18, 1564841192, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (67, 66, 0, 0, '1888555555', '1888555555', '4D5CDdE4', '1888555555', '2709ef118a8c716188fb2d9be0f25827', '5073', 91649.62, 1564841222, '', 0, 0, 'otqvfpnger3ofo3ub8q9mgrpb4', '44444444', '444444444', '4444444', '44444@qq.com', '444444444', '44444444444', NULL, 0, 0, 1, 1, 4.62, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (73, 0, 0, 0, 'admin', 'admin', 'OfiZigN702u8', 'admin', '62c208c97eab54634f67dec766f77041', '6365', 0.00, 1564936408, '', 1, 0, '404l02ofauo0jepef31gmi0ur7', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 0, 0.00, 1, NULL, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (69, 68, 2, 0, '13508080808', '13508080808', 'jxKP221m3Hvy', '13508080808', '13c05e5c445cc8f21cef30e8fb71e4a8', '4rAz', 0.00, 1564903065, '171.44.189.175', 1, 0, 'p53pmaa5k488mrifrijda41em4', NULL, NULL, NULL, '', '', '', '-68-', 1, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (70, 21, 1, 1, '13488888888', '13488888888', '4PB234ru22Yp', '1348888888', '26cd5cfa9cae68be66a3397be11ddddd', 'fm05', 27465.10, 1564917789, '49.156.33.4', 0, 0, '105ktratf33mfvi4qdf1q32cg0', '456456', '456456', '张', '654456456@qq.com', '456456456', '456456456456456456', '--21-', 1, 0, 1, 1, 165.10, 0, 0, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (71, 2, 0, 0, '13112345611', '13112345611', 'fA0dw4he', '13112345611', '1e90728d00535d574ec46e2d9d703d80', '9536', 10000000.00, 1564920869, '', 1, 0, '72biu5td0lvt3peeec1hc89j01', '1', '1', '1', '3319277666@qq.com', '3319277666', '350681198409152222', NULL, 0, 0, 1, 0, 0.00, 0, 66666, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (72, 1, 0, 0, '14795236763', '14795236763', 'dbm5LHXtdebi', '11', 'a893b21397ede3ee235a4b244e62c385', 'BMbf', 99994592.00, 1564935678, '60.176.76.216', 1, 0, 'qach2qk6m4e59sru8dl1tnpui5', '456464', '167864644', '黑猫', '20393989@163.com', '545424694', '450805658285646554', '-196-1-', 1, 0, 1, 1, 71.51, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (74, 72, 0, 0, 'maomao 01', '1815648646', '4hs45DD5', 'maomao 01', 'f7e9ef310347d94505713674962017ce', '4548', 0.00, 1564936691, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (86, 0, 0, 0, '18988998899', '18988998899', 'm20lgW0LfTHb', '18988998899', '1a0233fb846010694d39f9b7ccdd07fb', '2123', 0.00, 1565177246, '', 1, 0, '0edg0jvmtof6sh4shnbm4rf007', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (84, 73, 0, 0, 'member888', '18888888888', 'CF4BD55E', 'member888', '177bd29e30dadf9b86ef2912b122ae53', '6935', 10000.00, 1565060527, '', 1, 0, 'd4is3uicdjcfosbut2lo4gal14', '188888888', '188888888@163.com', '墨菲', '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (82, 0, 0, 0, '18396290177', '18396290177', 'cPiXiaOEVJiK', '18396290177', '3cbdc7f204533c64a13a26958641ebc0', '8937', 0.00, 1565034733, '', 1, 0, 'p9k21aqms574at9momv33d8eo7', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (83, 82, 0, 0, '15750735243', '15750735243', 'sS5BA0jD', '13112345611', '55295b5026dfa9aaecb415cfe74efd43', '9470', 10000.00, 1565035073, '', 1, 0, 'p9k21aqms574at9momv33d8eo7', '565455', '56544', 'kill', 'ghggc@qq.com', '53456985', '5368744', NULL, 0, 0, 1, 1, 0.00, 0, 10000, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (87, 0, 0, 0, '18533126614', '18533126614', 'tpCRbDTkOp7t', '18533126614', 'e0e09883c489a960f67886a4830d497e', '4249', 92143.20, 1565177965, '', 1, 0, 'fdgau2akeuudsvpjtnm0amb8v5', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 243.20, 1, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (88, 1, 0, 0, '陈', '15800000000', 'DhA10DB4', '陈', 'b4bf43ace6e094002a33f46b17810920', '4060', 0.00, 1565269172, '', 1, 0, 'gdam2e8s0htvcepc1ptfpd76n7', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (89, 87, 0, 0, 'BBC888', '1388888888', 'hfEh541A', 'BBC888', 'c362f205bd19f1d0969be055139cbfbd', '2922', 9000.00, 1565297309, '', 1, 0, '930gv3nn666qvl24405jm20a72', '能', '不能', '到你', '128425868@qq.com', '54575', '454872764', NULL, 0, 0, 1, 1, 0.00, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (90, 0, 0, 0, '15112861560', '15112861560', '0ARWcA830nKB', 'admin', '445eff02e386539071e79ca90b254155', '4155', 2000.00, 1565370829, '', 1, 0, 'e9lfsnpvffptuh1f8qt00u0cb7', '123456', '123456', '尹青波', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (91, 0, 0, 0, '13938064269', '13938064269', 'uxbJJskXPeIC', '13938064269', 'e4e7b1c2add09fad97328121cc61731a', '2968', 0.00, 1565514615, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (92, 0, 0, 0, '15880881850', '15880881850', 'AsXsxh98nvHZ', '15880881850', '5db56015dad4a262745b1e664f3730d9', '5083', 0.00, 1565534788, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (93, 92, 0, 0, '15526279728', '15526279728', '4BS4015f', '15526279728', 'e9291cda089bb033ad0cc5a3c05fc0fc', '8938', 0.00, 1565534861, '', 1, 0, '2g3ekvkh1mb9jmr1feb06i4923', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (94, 0, 0, 0, '0926602950', '0926602950', 'MTqXJ3YVZ4eR', '0926602950', 'ce65ff4e9d19070d169595fb7f9f84fd', '8424', 0.00, 1565593084, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (95, 94, 0, 0, '121212', '12121212121', 'h5h4CShB', '121212', 'e084d7c09d25bb7f91505d7059346423', '3800', 0.00, 1565593543, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (96, 0, 0, 0, '17112345678', '17112345678', 'xnX2KylTiNd0', '17112345678', 'c1f6813cdd7fcda41be7290315986670', '9529', 0.00, 1565750615, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (97, 67, 0, 0, '19917922661', '19917922661', '4hh1s5Aw', '19917922661', '0b88b4960873f9e378a4b077346ff196', '8015', 0.00, 1565848138, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (98, 0, 0, 0, '18570066850', '18570066850', 'HjuWfdPgfPHv', '18570066850', '2ff7df125570daf1c50b5a60d26ad6ae', '1584', 0.05, 1565947272, '', 1, 0, 'h16s8otbjvhcql9n05uvnpv7u3', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (99, 98, 0, 0, 'suxi3589', '18570036580', 'h4DEhA5w', 'suxi3589', '427bb5e6e6c6f2f9219dade2d69e6daa', '8320', 1455.50, 1565947359, '', 1, 0, 'e57rtefo505bpamqjkfh60ohj0', 'lusuxi', 'lusuxi', 'lusuxi', '358923476@qq.cm', '358923476', '4312568954231', NULL, 0, 0, 1, 1, 5.50, 0, 100, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (100, 1, 0, 0, '777', '777', 'AjB4sD0E', '777', 'bd2eaf015c8ff7be6c04cde0d63ed761', '6015', 0.00, 1566193856, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 0, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (101, 0, 0, 0, '18888889999', '18888889999', 'oQVLpALOJuP5', '18888889999', '5172e416fd09aaea1a9b000ad5933361', '4206', 0.00, 1566397702, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 0, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (102, 0, 0, 0, '1566666666', '1566666666', 'ZjPVYKKwnnQ6', '1566666666', '85dde99c3240e56e7599873a618df0e8', '3579', 0.00, 1566569556, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (103, 1, 0, 0, 'a5526897', '17703166584', 'DDD1hA41', 'a5526897', 'da3de69c112857e01b8a16e578d057e3', '8915', 0.00, 1566620104, '', 1, 0, NULL, '', '', '', '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (104, 1, 0, 0, 'zxc123', '13684876964', 'eh1d4h44', 'zxc123', '9320ea2b9ce0229cbe0f170ef781a3ae', '1853', 0.00, 1567047349, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 0, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (105, 7, 0, 0, '15541222155', '15541222155', '76Sv1kRSfyI4', 'ydoublel', '09c3400bd562c3b0c3b469cf663195ea', 'w4QQ', 4847.98, 1567315221, '42.249.51.176', 1, 0, 'jqdv9uoemef40ujppgg1p0qnj3', '39393939', '2828377@mail.com', '全球', '393@qq.com', '39399339', '20193701883830', '-7-', 1, 0, 1, 1, 1.98, 0, NULL, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (106, 1, 0, 0, '吧', '13570896511', 'De41BhD4', '吧', 'badf3ae2b8f46195ab55c70f018a86e5', '10', 0.00, 1567357366, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (107, 0, 0, 0, '18975711234', '18975711234', '1K15cLpBhaRz', '18975711234', '78f6102f65a95b5bf391bb22f93dd439', '7226', 698.05, 1567478599, '', 1, 0, 'm4fjrsua6ga5773d8nds4ojn23', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 631.05, 1, 0, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (108, 0, 0, 0, '18975711237', '18975711237', '5xY5jft5QASS', '18975711237', '0193c773c37a1c7d118300462426bf2b', '6771', 0.00, 1567514299, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (109, 108, 0, 0, '110', '4558745', 'ACDDwhhS', '110', '488fb654cce399cf153dc16be55fb765', '6518', 0.00, 1567514365, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (110, 107, 0, 0, '009', '18975711235', 'Ah5Ch1D4', '009', 'b5aadc20cc61e1b13c3ab635872e587f', '130', 95466.00, 1567517645, '', 1, 0, 'o17inev9mvtco3pfsp5m85k3h0', '566696', '888999', '龙五一', '13856876@qq.com', '8580755', '5568852655', NULL, 0, 0, 1, 1, 6340.99, 0, 0, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (111, 0, 0, 0, '17113141314', '17113141314', 'FGvzFu0eDIs8', '17113141314', '9460161b8266d41a1cd0eb878a654434', '4841', 0.00, 1567562753, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (113, 111, 0, 0, 'test123', '13000000000', '1d5FwCBE', 'test123', '482c28f3c3095328346244ca4d8b2163', '6360', 0.00, 1567589611, '', 1, 0, '8diurjhchs33n1sq825224vg57', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (112, 107, 0, 0, '008', '13549505371', 'Fe4dSD45', '008', 'd15672ab19545be02e66b97cea8662f1', '3962', 100000.00, 1567566832, '', 1, 0, NULL, '', '', '', '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (114, 0, 0, 0, '13800138111', '13800138111', '7YqjMZr8ittJ', '13800138111', 'd43cf5430ad64d12afdd140ff8af415f', '6288', 10000.00, 1567594241, '', 0, 0, '6536e76mb563d5fqd29jn82qf0', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (115, 0, 0, 0, '18568531155', '18568531155', 'QAtSRU6P3uqc', '18568531155', 'c004e17acd2cad23345514036e7a80de', '1456', 0.00, 1567769968, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (116, 9, 0, 0, '13812330018', '13812330018', 'F0B1hDd4', '13812330018', 'de47ba44b883e33bf6df6468bb30ea34', '2284', 20116.60, 1567844551, '', 1, 0, 'k5dcg7upu8tdg17285bsea61p1', '13812330018', '13812330018', '张某', '8488847@qq.com', '8488847', '320706198708091256', NULL, 0, 0, 1, 1, 666.60, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (117, 36, 0, 0, '17898511101', '123456', 'fwhjASS5', '17898511101', 'c8af03c29b41f13a90f254a40020ecce', '2891', 0.00, 1568018038, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 0, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (118, 0, 0, 0, '3113123424', '3113123424', 'q7hgbPt22Cb9', '3113123424', '80821d8b9cbef221794e1a6f1054ec38', '7279', 10000000.00, 1568043392, '', 1, 0, NULL, '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (119, 0, 0, 0, 'LELEI', 'LELEI', 'QzGOox2tno5B', 'LELEI', 'e208cc4cd832bd57bbef8e64ddf71e0d', '1031', 0.00, 1568641861, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (120, 0, 0, 0, '13999999999', '13999999999', 'XHxnthGtKTUm', '13999999999', 'd870b97765626ae4ed1a6e62e4504794', '9596', 21063.00, 1568701300, '', 1, 0, '4j8t7vi8b05547bi7sfvoram41', '', '', '', '', '', '', NULL, 0, 1, 1, 1, 0.00, 1, 0, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (121, 120, 0, 0, '13666666666', '13666666666', 'elMIlzxEFRiX', '小女子', '12b54b002d09da22f61daee87dfd52e7', 'hAio', 29626.00, 1568705259, '61.144.104.6', 1, 0, 'g8v5ijp3u612e9lgu74rdmqo47', '3366921', '13666666666', '小女子', '12345@163.com', '666666667', '6666666666666666', '-120-', 1, 0, 1, 1, 126.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (122, 0, 0, 0, '13777777777', '13777777777', 'BmduBpVmeqbe', '13777777777', '3dbae54b065f8e4e6d0c7e7a532aaab1', '9532', 0.00, 1568708528, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (123, 1, 0, 0, '123123123', '13112312312', '5h4C1e1D', '123123123', '92a4ccefaf33f6f9fcb41ae431ec4aa0', '2347', 4510.50, 1568712225, '', 1, 0, 'm6pe6bbl71g5dpg2varg5ssvu4', '123', '123', '123', '12345612@QQ.COM', '123418695132', '1234561321891459/865', NULL, 0, 0, 1, 1, 10.50, 0, 3, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (124, 1, 0, 0, 'ACACACAC', '17602087778', 'BDwA5F10', 'ACACACAC', '5f0ff97bc1f1906eed65bf953910811e', '1160', 0.00, 1569155440, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (125, 7, 0, 0, '13510076667', '13510076667', 'ZypFcw0B37aP', '王啊6', '341160213ef208cbed727a704915b370', 'km1c', 0.00, 1569160799, '116.26.128.27', 0, 0, NULL, NULL, NULL, NULL, '', '', '', '-7-', 1, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (126, 0, 0, 0, '', '', '6qXr3Xhd50Ll', '', '2ba7ac5c81fda32f55b36654eb586a6b', '8217', 0.00, 1569221856, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (127, 1, 0, 0, '张世豪', '13153559905', 'Ahhj54hf', '张世豪', '428600b1d6f084c3ff0072091ef7aa27', '6193', 0.00, 1569225924, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (128, 7, 0, 0, '15888888888', '15888888888', '9NfVHprD5JzE', '2888888888', '5a982417b85b62135305b1be59db8b60', 'Dk9D', 0.00, 1569265991, '223.104.65.60', 1, 0, NULL, NULL, NULL, NULL, '', '', '', '-7-', 1, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (129, 0, 0, 0, '13888881234', '13888881234', '4xgMuTBltx0N', '13888881234', 'd425d576a878f94712f068a997898e2e', '9336', 0.00, 1569336900, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (130, 0, 0, 0, '13933445727', '13933445727', 'cBQkKrbU0VA5', '13933445727', '18a49de7b79b576cdde2398d1244e09e', '5545', 0.00, 1569397983, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (131, 70, 0, 0, 'ts1234', '18080261713', 'DE5h5Cf4', 'ts1234', 'e260731e165c4ea2ef2e33b8a23703e6', '6724', 0.00, 1569399298, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (132, 0, 0, 0, '13859000638', '13859000638', 'NlaI4nqQNnOM', '13859000638', '5d88e90be7cf83fa3aa147ce55568126', '7845', 0.00, 1569501892, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (133, 0, 0, 0, '15980503407', '15980503407', 'ThGtyOJTwAsn', '15980503407', 'e81cf74c109a249d6763c5480471e577', '8281', 8.38, 1569502170, '', 0, 0, '1jthj5kg9arcqhnlas3n1m3092', '', '', '', '', '', '', NULL, 0, 2, 1, 1, 46.20, 1, 0, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (134, 133, 0, 0, '15680737571', '15680737571', 'd5ybsHyChSbV', '15680737571', 'e5127888d8e0cb6daf0a1dccf88dec25', '1FQ9', 362.81, 1569506630, '117.136.30.195', 1, 0, 'kh1eh8jv5cml2aupkttr8vonv7', '367889', '557@', '黑化股份', '5787655@qq.com', '7764578', '5688986534788', '-133-', 1, 1, 1, 1, 40.65, 0, 0, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (135, 134, 133, 0, '15980503405', '15980503405', 'dxQvNizy4A1L', '陈c 小小', '6384a2c052b5939cfeecc61865b0d33d', 'CLCW', 9500.00, 1569507654, '117.136.30.109', 1, 0, '1jthj5kg9arcqhnlas3n1m3092', '464664', '464664', '小心', '18156694@qq.com', '4949494', '466464646', '-133-134-', 1, 0, 1, 1, 10.90, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (139, 1, 0, 0, '112233', '17877227788', 'e4D5EFhw', '112233', '0d096a7bb2a1ec93fee952ee46f84c18', '4817', 333.00, 1569637796, '', 0, 0, NULL, '', '', '', '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (136, 133, 0, 0, '15305913361', '15305913361', '1tcFS0TsnGc6', '桃夭', 'db611aacf439cea3a98bef9bea16e7d6', '7Rtq', 0.00, 1569557075, '112.49.139.59', 1, 0, 'n7nq7e56j1c7vv9v9j5oop6d23', NULL, NULL, NULL, '', '', '', '-133-', 1, 0, 0, 1, 0.00, 0, NULL, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (137, 0, 0, 0, '123123123123', '123123123123', 'qx48F3QaIIiy', '123123123123', '97fb945f72689b78595c98c699938b6f', '8788', 0.00, 1569568562, '', 0, 0, 'm6pe6bbl71g5dpg2varg5ssvu4', NULL, NULL, NULL, '', '', '', NULL, 0, 1, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (138, 137, 0, 0, '13627125737', '13627125737', 'QZUnKWCNDDNZ', 'ceshi1', 'f6403851b0c7b2dc098db9e992d5c3d8', 'aOEy', 0.00, 1569568800, '117.154.71.217', 1, 0, 'hk05tvf7d5oqddoqvc75kegtg4', NULL, NULL, NULL, '', '', '', '-137-', 1, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (140, 1, 0, 0, '不知道', '17877667766', '54144S0w', '1787727766', '3d18a2647c2452e1560bc751f3cb64e7', '1274', 0.00, 1569638261, '', 0, 0, '8jes9ndkqu1ioks4hdfqa4cco5', '123456', '17877667766', '不知道', '123456@qq.com', '123456', '4567982555', NULL, 0, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (141, 9, 0, 0, '13169258523', '13169258523', 'ByPpLJFBqebK', '想法了', 'c087ec64af857c3930e3e831538dd23c', 'LeCY', 10.00, 1570132666, '218.204.253.84', 0, 0, NULL, '', '', '', '', '', '', '-9-', 1, 0, 0, 1, 0.00, 0, 30, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (148, 118, 0, 0, '12', '12', '0wE4sF1h', '12', '69e49ee0fc642ea5cb4b37a29e33bfc8', '9099', 0.00, 1571559087, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (142, 9, 0, 0, '18569438059', '18569438059', '8rgY9leoEIk7', '如梦', '8d44d30d1c85dd20d09a83751da7faab', '1GjH', 10000.00, 1570191973, '223.88.29.177', 1, 0, 'lflkm121ut1b983q5gver03mm5', '', '', '', '', '', '', '-9-', 1, 0, 0, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (143, 9, 0, 0, '13111111111', '13111111111', '6mD1b7hK8qJb', '13111111111', 'de3271516f5350c5496da291a1b285d3', 'AAqi', 0.00, 1570364166, '211.97.129.75', 1, 0, NULL, '', '', '', '', '', '', '-9-', 1, 0, 0, 1, 0.00, 0, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (144, 74, 0, 0, '222222', '155****8888', 'EBSDheD1', '222222', '24405441121d1726830cfc38f4393517', '622', 0.00, 1570527250, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (145, 9, 0, 0, '17666032583', '17666032583', 'lfaSzlascXWu', '张峰', 'b73590a6e48b21d00c880107892a29c3', 'xW8y', 110111.06, 1570847481, '119.39.248.82', 1, 0, 'ou47e0t2islu7jcjjnign40710', 'jj', 'jj', 'hhh', '101@qq.com', '88', 'jj', '-9-', 1, 1, 1, 1, 7.06, 0, 1, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (146, 145, 9, 0, '17775838321', '17775838321', 'TEEAv4TPttVw', 'lv123456', '0ac4b17cdf29e6400a4e91754c615e58', 'Ka1Y', 9999.00, 1570849554, '106.18.182.153', 1, 0, '53d6u4ovpcje11d6esrgc957j0', 'lv7827858', '177583', '吕盛', '204946@qw.com', '280018814', '430124198999991010', '-9-145-', 1, 0, 1, 0, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (147, 0, 0, 0, '13838888888', '13838888888', 'AVFJXCenxV3Q', '13838888888', '9a122842df7adf4b84cb0ef7ca3ae863', '1963', 0.00, 1570996428, '', 1, 0, 'pgnh4o48n6t6ot1p3qp03rcl54', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (152, 1, 0, 0, '13111112222', '13111112222', 'F4C5whDh', '13111112222', '9f460f71fc211a65f75c56313653b228', '6894', 2758.45, 1572085352, '', 1, 0, 'jg2m81k52tgs7u1f2h0950c7f1', '', '', '王时尚', '272829299@qq.com', '272829299', '28283739', NULL, 0, 2, 1, 1, 176.50, 1, 10, 0, 6, 0, '');
INSERT INTO `ysk_user` VALUES (149, 0, 0, 0, '13255567890', '13255567890', 'FQITjxQCzZL1', '13255567890', '7d3c6625630cbc6656f27503d76c12f4', '9927', 0.00, 1571639941, '', 1, 0, 'uf4munuifrm3cs9sboik8frvh0', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 0, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (150, 0, 0, 0, '13035720198', '13035720198', '7w2cyeiQT7et', '13035720198', '486a2947e66890bdae77dcaec757a266', '5969', 0.00, 1571991436, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (151, 9, 0, 0, '13169215839', '13169215839', 'cD9JzodL4tgk', '13169215839', '8d61844c5c849aaf815ef09111057955', 'E3PS', 100000.00, 1571995161, '112.97.53.228', 1, 0, 'gp7p20ongrnv1rk029g2de5km2', '', '', '', '', '', '', '-9-', 1, 0, 0, 1, 0.00, 0, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (153, 0, 0, 0, '12345678900', '12345678900', '3xaKlaKRSVuL', '12345678900', 'ee289333d4465ef75b7cbff88d70b580', '9290', 0.00, 1573202234, '', 1, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, NULL, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (154, 9, 0, 0, '18318339934', '18318339934', 'jiitMAgUaAlo', '鹤山', 'e224b36bfba7da6d93183fbee5081e54', 'eTJ3', 0.00, 1573563661, '14.30.29.244', 1, 0, 'n1qqculkkjnnf1qd0rl5bl5h83', '5', '4', '', '', '', '', '-9-', 1, 0, 0, 1, 0.00, 1, 0, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (155, 152, 1, 0, '13100006666', '13100006666', '2LAvjKp3UPRN', '13100006666', 'be3191fc10d8cfd989511ff3f961c626', 'JnEZ', 2956.18, 1574250817, '171.117.190.133', 1, 0, 'ekbltjuik2taoer8vmth2fd0p1', 'A', 'D', 'As', 'Www@qq.com', 'Uuuu', 'Hhhhhh', '-152-', 1, 1, 1, 1, 204.50, 1, 88, 0, 5, 0, '');
INSERT INTO `ysk_user` VALUES (156, 155, 152, 1, '13100007777', '13100007777', 'z5UQOXz6EOHh', '13100007777', '4fd7a246ce48098f59d9c88426704567', 'y7zp', 5982.60, 1574252582, '171.117.190.133', 1, 0, 'ekbltjuik2taoer8vmth2fd0p1', '1', '1', '1', 'ttt@qq.com', '5555555', '34445', '-152-155-', 1, 0, 1, 1, 182.60, 1, 100, 0, 4, 0, '');
INSERT INTO `ysk_user` VALUES (157, 0, 0, 0, '18731028899', '18731028899', 'T43gcVRJr4Da', '18731028899', '6dad7469a220501783e89c926620ad94', '5368', 522.50, 1574664549, '', 1, 0, 'kl5cf3aiof0plmf7qrimsi1t31', NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 22.50, 1, 10, 0, 3, 0, '');
INSERT INTO `ysk_user` VALUES (158, 157, 0, 0, '啊坤', '14888888888', 'shhF4S40', '啊坤', '083a3d5331c80ed627df3e3b400d1afe', '990', 0.00, 1574664911, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (159, 0, 0, 0, '13931091933', '13931091933', '0pWBI9QoVt6A', '13931091933', '71a76215198c13fb657a900882e0d364', '7376', 100237.00, 1574668943, '', 1, 0, 'gjj3a7u3417f2qsknn9cfkol34', '', '', '', '', '', '', NULL, 0, 0, 1, 1, 173.50, 1, 1000, 0, 24, 0, '');
INSERT INTO `ysk_user` VALUES (160, 159, 0, 0, '14033033330', '13033033330', 'jSE1Fh54', '14033033330', 'acc6f973afb6ed5223e835500ce11f67', '5926', 3000.00, 1574746187, '', 1, 0, 'jg2m81k52tgs7u1f2h0950c7f1', '', '', '', '', '', '', NULL, 0, 0, 0, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (163, 152, 1, 0, '13500100001', '13500100001', 'W9eFPgQH4odu', '张学友', '615c71483a5bb5feb33609f08ff0c78c', 'CRIn', 10500.00, 1575299823, '223.104.3.30', 1, 0, 'jg2m81k52tgs7u1f2h0950c7f1', '123', '123', '张学友', '123', '', '123', '-152-', 1, 0, 0, 1, 0.00, 1, 100, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (161, 7, 0, 0, '13444444444', '13444444444', 'E6pJPia1CYey', '123', '8cc47fcbb54fc597468c3409ef87505c', 'UyKT', 0.00, 1574994214, '14.111.59.27', 1, 0, NULL, NULL, NULL, NULL, '', '', '', '-7-', 1, 0, 0, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (162, 7, 0, 0, '13555555555', '13555555555', 'Q4hbylOrjQlB', '41251', '4a71ebef2f1b4f46c5145c3747ef3361', 'Sob5', 0.00, 1574994298, '14.111.59.27', 1, 0, NULL, NULL, NULL, NULL, '', '', '', '-7-', 1, 0, 0, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (164, 9, 0, 0, '13783914073', '13783914073', 'dUvuFoZ2p9jD', '张磊', '5e95053dab554c2ab956c4e36657e02d', 'Ah60', 6589.72, 1576068774, '222.136.28.156', 1, 0, 'rvck1os8jj9usfmkuu1gsks663', 'a2752365', '', '张磊', '', '', '', '-9-', 1, 0, 1, 1, 90.00, 1, 30, 1, 4, 0, '');
INSERT INTO `ysk_user` VALUES (165, 0, 0, 0, '14725836900', '14725836900', 'y4dHcTVeI8pK', '14725836900', 'd942ba845b9db33d2741c8150a6bb9c3', '4027', 13368.42, 1577451472, '', 1, 0, 'an7s2i23cvo5jagn5d2hr57en7', '', '', '', '', '', '', NULL, 0, 42, 1, 1, 2508.00, 1, 50, 0, 25, 0, '');
INSERT INTO `ysk_user` VALUES (166, 165, 0, 0, '18022484190', '18022484190', '49OpKLLkpEgB', '陈冬明', '30b9981d747a5400a2c98835bf90295c', 'nCYf', 0.90, 1577857596, '218.87.157.27', 1, 0, 'ev3upcffa392vd77ogm80plnh2', '', '', '', '', '', '', '-165-', 1, 0, 1, 1, 4.90, 0, 10, 0, 1, 0, '');
INSERT INTO `ysk_user` VALUES (167, 165, 0, 0, '15715928077', '15715928077', 'gOe1llmIGswc', '范孝是', '264f0aa72587323860758e8a89c77e79', 'kQps', 0.00, 1577857964, '117.136.75.41', 1, 0, 'jso8bh65b56in80q01c4iqmgb7', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (168, 165, 0, 0, '18035881118', '18035881118', 'mtwF9rsIory6', '李娜', 'f7fcbed522653fc97f27a8197bdaad78', 'IjaE', 0.00, 1577858694, '1.68.56.121', 1, 0, '5cjb55jco29911ecq6b4efhu97', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (169, 165, 0, 0, '18928696507', '18928696507', 'jIeS31UR8VwL', '陈超威', 'b58352a7e5e3b914c94e7e5917ec949c', 'be1q', 0.00, 1577859401, '113.70.210.192', 1, 0, 'etvoh8pbo184sd8324e566i483', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (170, 165, 0, 0, '17532572345', '17532572345', 'Tq5LV2si3sHd', '师远东', 'b729473477295ef2fa869d13e0edacba', 'guZU', 0.00, 1577859568, '27.188.231.141', 1, 0, '1llg5b3vdpl0con6lj0bt35qm0', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (173, 165, 0, 0, '18873723013', '18873723013', '0XdsEzyNKsBy', '张可仁', '555572fbe7a44fa8daef8b4065a0fc06', 'KJQf', 0.00, 1577864093, '119.39.248.49', 1, 0, '6bpak6t0t1anrkqlaggfjk6ph0', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (171, 165, 0, 0, '18846433059', '18846433059', 'cCvi34SaBWS5', '李刚', 'e7acb25a19bb5b3ba5cb279b8a934304', 'BNNO', 507.00, 1577860611, '123.166.207.98', 1, 0, '05hl0ff0a7dug1sa7972sa0d61', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 5.00, 0, 10, 0, 1, 0, '');
INSERT INTO `ysk_user` VALUES (172, 165, 0, 0, '18075031017', '18075031017', 'ReWoNOYsNze3', '荣发涛', 'c3d7bb356505ca31a587b64dc10bcea8', 'zG2X', 43.00, 1577861043, '183.167.23.108', 1, 0, 'gng8klqboe96j905aohvkk9ff0', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 39.00, 0, 10, 1, 4, 0, '');
INSERT INTO `ysk_user` VALUES (174, 165, 0, 0, '15215716237', '15215716237', 'rGQJgvdAcbpb', '张新英', '56be4f1fc5493b6ad6d6ab380170da3a', 'D6Sp', 0.00, 1577867076, '112.17.238.79', 1, 0, 'jbe7klhv68020n5skfr2195810', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (175, 165, 0, 0, '19970864077', '19970864077', 'y41uXpT638eT', '谭志远', 'c3d86beaf82cb16bac63ecd480fb10f4', 'aeEl', 0.00, 1577868365, '182.97.135.41', 1, 0, 'fcqrqfgqfcsauifrmf5bbqhub1', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (176, 165, 0, 0, '17521149197', '17521149197', 'djOB2nIEYNOd', '王新钘', '055f026a58306bfc10a92fbbe2c29bab', 'PG0W', 0.00, 1577885851, '114.220.156.242', 1, 0, 'sf1omp476sl1ff67one3ubgbf7', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (177, 165, 0, 0, '18855682222', '18855682222', 'tx3Cvsm4E4fU', '余晨曦', '3b224db4d167c6367501b7eb0e13eb7b', '5ywD', 0.00, 1577976833, '183.160.226.92', 1, 0, 'drbi3o07dr92k1pc4dknq5sqi6', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (178, 165, 0, 0, '18648476450', '18648476450', '4IlfL0gHdQOS', '张乐', 'a86749e75c2832c2eca989d279934043', 'yjXi', 0.00, 1577978374, '110.17.1.239', 1, 0, 'oudg55d5mn3thbm39edhc2dn47', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (179, 165, 0, 0, '15665431432', '15665431432', 'aWzTOo4trRat', '余晨曦', 'e9d79a67995f7a865fc2b0eb5428d2d2', 'gEcB', 1.00, 1577978421, '223.104.34.94', 1, 0, '2j9qreu724ekri9u4h9afsert4', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (180, 165, 0, 0, '15051491491', '15051491491', 'CTXs6en6rRWg', '周志刚', '6ade329f13e0b511f73e58e757673eae', 'wjrj', 0.00, 1577978614, '122.238.61.162', 1, 0, 'hcj7co99ufid2t5a1jcpi1d0t1', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (181, 165, 0, 0, '13713948362', '13713948362', 'aDqv5Uk6MP8w', 'wang19880910', 'b6dbfc8cbf959a5ccb1034c2682a56cf', 'SSeJ', 0.00, 1577978821, '119.123.31.122', 1, 0, 'p1qf548bjs65uchoonsan07vs1', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (182, 165, 0, 0, '15679816051', '15679816051', 'G3umi5c7NshT', 'superggh', '669a7783fd38efc3b245df5b3fb9aeba', 'KoJ9', 0.00, 1577979106, '183.251.92.237', 1, 0, '7hht8fkh7fta5simmu0vnui2f2', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (183, 165, 0, 0, '13110115142', '13110115142', '64fYjx4UulN3', '徐徐', 'bc80c9be4594580be51b2e738bade79f', 'B9ra', 0.00, 1577980929, '125.84.188.28', 1, 0, '47enn79evd8k27lm08ipeej413', '', '', '', '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (184, 165, 0, 0, '18520182079', '18520182079', 'sjy9r1XUAKi9', '大胖', 'ce44a5afbe083a181034dfd7edaa76fc', 'NOtZ', 0.00, 1578012746, '112.96.173.233', 1, 0, 'c6dq9jg4n9icdf680eei6moco2', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (185, 165, 0, 0, '15322312626', '15322312626', 'Sd8nWKeWpFyC', '轩柏', '236371a7def7ac8271f61950165d9104', 'WTL6', 0.00, 1578014866, '113.67.19.41', 1, 0, '3neof058a50al3m810mujm39g5', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (186, 165, 0, 0, '13386909567', '13386909567', '4xuTw5mxD1bi', '李大帅逼', '190350110537d9e9cf26fac359eadfc8', 'yhXl', 0.00, 1578026171, '27.159.251.2', 1, 0, 'l4q0env5uldrik40a6qqs34hi0', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (187, 165, 0, 0, '15306350631', '15306350631', 'i6LePYg4PBir', '李纯兵', '9b78c5faecc1ce441255e6d4f9e60952', 'NPcJ', 0.00, 1578027425, '113.129.56.6', 1, 0, 'm76erueani1ve3ufrior2p05o4', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (188, 165, 0, 0, '15666854567', '15666854567', '74hMO6G07IRy', '姜万飞', '67d1dd8f1fe7ab2c4c415871aacbf1db', 'q551', 0.00, 1578027545, '112.38.61.106', 1, 0, 'r7chp3364shbsk4nanubdvqf86', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (189, 165, 0, 0, '13693146786', '13693146786', 'Iwvbin2NAnbZ', '花杰', '0c6e05344c94b6eb4ef411679b1f9ae7', 'ejMA', 0.00, 1578029462, '223.104.3.145', 1, 0, 'brhcpotgige7vh52rt385kcb12', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (190, 165, 0, 0, '18558925009', '18558925009', '8WHDWHJRlx49', '罗丁根', 'dca58b721a25e0ac8d88a2aa94e83e36', 'r3Dw', 0.00, 1578033627, '220.249.163.44', 1, 0, 'bjc0cp4q294bilqpra4i8g1o61', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (191, 165, 0, 0, '18371000792', '18371000792', 'QzCfy0Tpw0A6', '心痒痒', 'c38257022639f9ae4074bd1609f514d1', '5CsN', 0.00, 1578038882, '116.136.21.240', 1, 0, '9l0sdv18v3og619aa6a2rpbsj3', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (192, 165, 0, 0, '18972222582', '18972222582', 'uA1a0rrPhlUC', '李光宇', 'eece617c8e8ccafa1177b77d76562066', 'KEQe', 0.00, 1578041205, '171.82.191.40', 1, 0, 'gaatk686thqcnsa0ej0gtt65c5', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (193, 165, 0, 0, '15838717882', '15838717882', 'qgDMaKTSBJPt', '秦守博', 'e90ff49632cf1d77bdb82adb547bfe4b', '3DQg', -4924.00, 1578041979, '61.158.147.132', 0, 0, 'q6q9ciosvo9c4c4pqusc7o33d5', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 75.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (208, 165, 0, 0, '15979798334', '15979798334', 'hTKr2YinjHuq', '黄海波', 'dfb8c878ae5e991624480d1568b956ab', 'fwpg', 0.00, 1578377591, '117.136.124.25', 1, 0, 'vqibv3veh1mveu5k3i8oi8ebk7', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (194, 165, 0, 0, '18818907350', '18818907350', 'xaE0JZQxPER1', '黄金容', 'cabb63d4e855a89bd034dc280b8f60e4', 'AVCY', 0.00, 1578104828, '113.67.17.203', 1, 0, 'j343fkl92utdiju8hrjk7sqb66', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (195, 165, 0, 0, '13153688111', '13153688111', 'OSLTAhzSDt7o', '胡烨光', '04213ac2b966b93ec4f04265ac7f4c87', 'jq5y', 0.00, 1578130069, '112.224.67.187', 1, 0, 'g6n1g01ki5gldjcben93gjqc60', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (196, 165, 0, 0, '17703945962', '17703945962', 'u2VjWxo1o8fX', '郭义文', '1b1f73f3d192d97806d0c1d070970d8f', 'F4Gi', 0.00, 1578298074, '171.10.39.120', 1, 0, '09g04go4piav1p2uguk7npgup6', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (197, 165, 0, 0, '13949018408', '13949018408', 'S8MJIEgxpwEv', '陈鹏飞', 'da9ab27fd42daba172a7312249a2fb12', 'd9uw', 0.00, 1578298249, '223.104.108.63', 1, 0, 'i119clptb1kfg2kqregvi8esm4', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (198, 165, 0, 0, '19961980369', '19961980369', '6ep6H7j6Ua9Z', '刘杨', 'a5c73dd83ef9711237d46f6d5983805a', 'NulM', 0.00, 1578298845, '49.94.25.229', 1, 0, '5eb560q8bqiut41gsk731tojo2', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (199, 165, 0, 0, '13398322087', '13398322087', '2HxPqVcFXHAx', '欧波', '18c4cfb4cebe7e2183d4efcfb715726d', 'XIY7', 0.50, 1578298932, '171.216.246.167', 1, 0, '8emas8pqdtgmj7rqvrdcvhs6m6', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 82.50, 0, 10, 1, 2, 0, '');
INSERT INTO `ysk_user` VALUES (200, 165, 0, 0, '15858874434', '15858874434', 'E3LBaC4YCGAS', '冯建和', '1df25d78ddb552731deb1b9aafacc0d6', 'x6aR', 0.00, 1578299082, '112.17.236.196', 1, 0, '3pbekv4sv17gclantcf7mgqoc5', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 1, 0, 0, '');
INSERT INTO `ysk_user` VALUES (201, 165, 0, 0, '18831206543', '18831206543', 'zkoifXNCbLTN', '胡子明', '3687448728e1ee9ec3151f6aad599c11', 'nS40', 0.00, 1578299644, '101.74.83.230', 1, 0, 'e23mmrhg4tpm12p9t863r0mt52', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (202, 165, 0, 0, '18768894087', '18768894087', 'j3ixQeCJKzwF', '九', '224989c52246d8db325464e7aea4e7a9', 'epuO', 0.00, 1578299923, '117.136.44.176', 1, 0, NULL, NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (203, 165, 0, 0, '18236665590', '18236665590', 'RSaOisxYwQ6f', '王', '6a0c6c8b000c2111d1c8bb62daff8ed7', 'z71c', 0.00, 1578300198, '117.136.44.176', 1, 0, '4ce6ro0m5a0s69lmmhj4crlb16', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, NULL, 0, 0, '');
INSERT INTO `ysk_user` VALUES (204, 165, 0, 0, '13255445422', '13255445422', 'BFwP2pVFVp7r', '孙伯炀', 'e1931c3fa1d6d5c1d58328778f4fdd2d', 'kBWE', 0.00, 1578303841, '111.14.38.29', 1, 0, 'jl08u596dauptllbhndf0lphh0', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (205, 165, 0, 0, '13674941913', '13674941913', 'RYt1X16kgdZZ', '宋信帅', '342ae2f2a2af2fe47a02b7693f9c4a8e', 'YStN', 0.00, 1578304375, '223.104.111.252', 1, 0, 'jrtlvhvg27sv575jo17m3c86i1', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (206, 9, 0, 0, '15518888888', '15518888888', 'eF6zhAKMCwjZ', '小朋友', 'f3db8e48121c149ca507d71d4fbf96b8', 'e4xj', 0.00, 1578305157, '115.48.58.244', 1, 0, 'vp3ujivj3fh0j19fdsv09160l7', '', '', '', '', '', '', '-9-', 1, 0, 1, 1, 0.00, 1, 50, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (207, 165, 0, 0, 'agent', 'agent', 'lou3zXfe7WBD', '罗天', '5b17fd8dcec9cb30310b7d1ee9eb5ae8', '4950', 0.00, 1578319936, '42.232.94.123', 1, 0, '2lql7enfejgledfr4me7omc074', NULL, NULL, NULL, '', '', '', '-165-', 1, 0, 1, 1, 0.00, 0, 10, 0, 0, 0, '');
INSERT INTO `ysk_user` VALUES (209, 0, 0, 0, 'agent1', 'agent1', 'B9SR707tC64I', 'agent', '5b17fd8dcec9cb30310b7d1ee9eb5ae8', '4950', 0.00, 1587619192, '', 0, 0, NULL, NULL, NULL, NULL, '', '', '', NULL, 0, 0, 1, 1, 0.00, 1, 10, NULL, 0, 0, '');
...
CREATE TABLE `ysk_userrob`  (
  ...
  `uaccount` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '会员账号',
  `uname` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '会员姓名',
  `ppid` int(11) NOT NULL COMMENT '匹配的ID号',
  `status` int(2) NOT NULL COMMENT '状态1等2匹配中3成功',
  `addtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '添加时间',
  `pipeitime` int(10) NOT NULL COMMENT '匹配成功时间',
  `finishtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '交易完成时间',
  `ordernum` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单号',
  `pay_sn` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '充值编号',
  `pay_money` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `idewm` int(11) NULL DEFAULT NULL,
  `ts` int(11) NOT NULL DEFAULT 0 COMMENT '是否投诉',
  `tspic` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '投诉图片',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uid`(`uid`, `class`) USING BTREE,
  INDEX `ordernum`(`ordernum`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 137 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员抢单表前台发起的' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ysk_withdraw`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `uid` int(11) NOT NULL COMMENT '会员ID',
  `account` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '提现账号',
  `name` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '提现人姓名',
  `way` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '提现方式',
  `price` float(10, 2) NOT NULL COMMENT '提现金额',
  `addtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '提现时间',
  `endtime` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '完成时间',
  `status` int(11) NOT NULL COMMENT '状态1提交，2退回3成功',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 50 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '提现申请表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `z_log`  (
  ...
  `addtime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1818 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
