...
<form action="/apiss.php" method="post" autocomplete="off">
    <!--弹窗开始-->
    ...
    <div class="w1080 order-amount12" style="border-radius: 1em;height: 11rem;">
        ...
        <div class="order-amount12-right">
            ...
            <p class="l">商户账号：<input type="text" value="222" name="shid"></p>
            <p class="l">商户秘钥：<input type="text" value="BE47DWAC05N16Y84YR58L88GP2FMJAGF" name="key"></p>
            <p class="l">商户回调地址： <input type="text" name="url" value="http://agent.com/notify_true.php"></p>
        </div>
    </div>
    <!--订单号-->
