...
<form action="http://api.paof58.com/apiss.php" method="post" autocomplete="off">
<!--弹窗开始-->
...
<div class="w1080 order-amount12" style="border-radius: 1em;">
    ...
    <div class="order-amount12-right">
        ...
        <span>元</span>
		 <p></p>
        <span>商户账号： <input type="text" value="pf888" name="shid" ></span>
        <br>
        <span>商户秘钥： <input type="text" value="5I1QWR3OT0Z4ZOTBDU28VYFLLM45HJME" name="key" ></span>
