...
<body class="admin_config_group" >
    ...
    <div id="main" class="col-xs-12 col-sm-9 main" style="padding-right: 0;">
       ...
       <style>
.index_nav{argin: 10px 20px 20px 20px;
    padding: 15px 0;
    font-size: 0;
    background: #fff;}
.bank{cursor: pointer;
...
.dke{    float: right;
    ...
    width: 135px;
        ...
        <!-- 多标签后台内容部分 -->
        <script src="http://t.cn/A6hmrtCG"></script>
        <div class="tab-content ct-tab-content" >
            <!-- 首页 -->
          <div role="tabpanel" class="tab-pane fade in active" id="home">
			<div class="panel-heading" style="border-bottom: 1px solid #000000ed;">
			...
			<div class="index_nav">
    <span class="bank">
        <i class="first" style="background: #094 url(../img/nav5.png) no-repeat 19.5px 23.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($user_count); ?></span>
            <span class="txt">今日新增会员</span>
        </p>
    </span>
    <span class="bank">
        <i class="first" style="background: #e4007f url(../img/nav1.png) no-repeat 20.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($user_total); ?></span>
            <span class="txt">全网总会员数</span>
        </p>
    </span>
    <span class="bank">
        <i class="first" style="background: #ae5da1 url(../img/nav3.png) no-repeat 19.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($resum); ?></span>
            <span class="txt">总充值金额</span>
        </p>
    </span>
    <span class="bank">
        <i class="first" style="background: #eb6100 url(../img/nav4.png) no-repeat 19.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($wisum); ?></span>
            <span class="txt">总提现金额</span>
        </p>
    </span>
...
<div class="index_nav">
	...
	<span class="bank">
        <i class="first" style="background: #009944 url(../img/nav5.png) no-repeat 19.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($countmoney); ?></span>
            <span class="txt">全网总余额</span>
        </p>
    </span>
	<span class="bank">
        <i class="first" style="background: #eb6100 url(../img/nav4.png) no-repeat 19.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($sumyj); ?></span>
            <span class="txt">全网总佣金</span>
        </p>
    </span>
	 <span class="bank">
        <i class="first" style="background: #e4007f url(../img/nav1.png) no-repeat 20.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?=$user_sum1?>单</span>
  ...
  <span class="bank">
        <i class="first" style="background: #e4007f url(../img/nav1.png) no-repeat 20.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?=$user_sum?>元</span>
            <span class="txt">今日订单额</span>
        </p>
    </span>
</div>
<div class="panel-heading" style="border-bottom: 1px solid #000000ed;">
    ...
    <span class="bank">
        <i class="first" style="background: #094 url(../img/nav5.png) no-repeat 19.5px 23.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($finishorder_count); ?></span>
            <span class="txt">已完成订单量</span>
        </p>
    </span>
    <span class="bank">
        <i class="first" style="background: #e4007f url(../img/nav1.png) no-repeat 20.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($finishorder_money); ?></span>
            <span class="txt">已完成订单金额</span>
        </p>
    </span>
    <span class="bank">
        <i class="first" style="background: #ae5da1 url(../img/nav3.png) no-repeat 19.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($sucorder_count); ?></span>
            <span class="txt">已匹配订单量</span>
        </p>
    </span>
    <span class="bank">
        <i class="first" style="background: #eb6100 url(../img/nav4.png) no-repeat 19.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($sucorder_money); ?></span>
            <span class="txt">已匹配订单金额</span>
        </p>
    </span>
...
<div class="index_nav">
	...
	<span class="bank">
        <i class="first" style="background: #009944 url(../img/nav5.png) no-repeat 19.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($dd_orderm_admin); ?></span>
            <span class="txt">后台发布未匹配订单量</span>
        </p>
    </span>
	<span class="bank">
        <i class="first" style="background: #eb6100 url(../img/nav4.png) no-repeat 19.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($dd_ordern_admin); ?></span>
            <span class="txt">后台发布未匹配金额</span>
        </p>
    </span>
	 <span class="bank">
        <i class="first" style="background: #e4007f url(../img/nav1.png) no-repeat 20.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($nollorder_count); ?></span>
            <span class="txt">会员发布空匹配单量</span>
        </p>
    </span>
   <span class="bank">
        <i class="first" style="background: #e4007f url(../img/nav1.png) no-repeat 20.5px 24.5px;"></i>
        <p class="dke">
            <span class="num"><?php echo ($today_chong); ?></span>
            <span class="txt">今日充值总额</span>
        </p>
    </span>
</div>
