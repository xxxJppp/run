                                ...
                                <table class="table table-condensed">
                                    <tbody>
										...
										<tr>
                                            ...
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($resum); ?></td>
                                        </tr>
										<tr>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">总提现金额：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($wisum); ?></td>
                                        </tr>
										<tr>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">全网总余额：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($countmoney); ?></td>
                                        </tr>
										<tr>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">全网总佣金：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($sumyj); ?></td>
                                        </tr>
										<tr>
                                ...
                                <table class="table table-condensed">
                                    <tbody>
										...
										<tr>
                                            ...
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($finishorder_money); ?></td>
                                        </tr>
                                        <tr>
