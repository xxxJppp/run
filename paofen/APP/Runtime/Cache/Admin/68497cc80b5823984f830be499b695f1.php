                                ...
                                <!-- 工具栏按钮 -->
                                    <div class="col-xs-12 col-sm-8 button-list clearfix">
                                        <div class="form-group">
                                            <a title="备份数据库" class="btn btn-primary-outline btn-pill ajax-post confirm" target-form="tables" model="Database" href="<?php echo U('export');?>">备份数据库</a>&nbsp;
                                            <a title="优化" target-form="tables" class="btn btn-success-outline btn-pill ajax-post confirm" model="Database" href="<?php echo U('optimize');?>">优化</a>&nbsp;
                                            <a title="修复" target-form="tables" class="btn btn-warning-outline btn-pill ajax-post confirm" model="Database" href="<?php echo U('repair');?>">修复</a>&nbsp;
