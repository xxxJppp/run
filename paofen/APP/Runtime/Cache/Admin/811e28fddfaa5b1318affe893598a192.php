                                            ...
                                            <div class="form-group right">
                                                ...
                                                <div style="float:left;width:10%" class="input-group search-form ssssy">  <span style="float:left;height: 34px; ">金额</span>
                                                  <input  type="text" name="money" class="search-input  " value="<?php echo ($_GET["money"]); ?>"  placeholder="" style="float: left;width: 70%;"> </div>
                                                   <div style="float:left;width:15%" class="input-group search-form ssssy">  <span style="float:left;height: 34px; ">商户订单号</span>
                                                  <input  type="text" name="shdd" class="search-input  " value="<?php echo ($_GET["shdd"]); ?>"  placeholder="" style="float: left;width: 60%;"> </div>
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                  ...
                                                  <th style="font-size:12px;">商户订单号</th>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                          ...
                                                          <td style="font-size:12px;"><?php echo $v['pay_sn'];?></td>
