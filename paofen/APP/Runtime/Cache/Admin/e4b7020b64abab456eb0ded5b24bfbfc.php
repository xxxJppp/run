   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            <li><i class="fa fa-map-marker"></i></li>
             ...
             <li class="text-muted">商户管理 /  商户列表</li>
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-size:12px;">商家秘钥</th>
                                                    <th style="font-size:12px;">商家网站</th>
                                                    <th style="font-size:12px;">商户余额</th>
                                                    <th style="font-size:12px;">登录次数</th>
                                                    <th style="font-size:12px;">开通时间</th>
                                                    <th style="font-size:12px;">费率</th> 
                                                    <th style="font-size:12px;">收款统计</th>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
															...
															<td style="font-size:12px;"><?php echo $v['names'];?></td>
															<td style="font-size:12px;"><?php echo $v['key'];?></td>
                                                            <td style="font-size:12px;"><?php echo $v['url'];?></td>
															<td style="font-size:12px;"><?php echo $v['money'];?></td>
															<td style="font-size:12px;"><?php echo $v['login_num'];?></td>
															<td style="font-size:12px;"><?php echo date('Y-m-d H:i:s',$v['addtime']) ;?></td>

															<td style="font-size:12px;">微信<?php echo $v['wx'];?>%,支付宝<?php echo $v['zfb'];?>%,商家码<?php echo $v['sjm'];?>%</td>

															<td style="font-size:12px;">昨日<?php echo yestongji($v['names']);?>元,今日<?php echo totongji($v['names']);?>元</td>
															...
															<td style="font-size:12px;">
																<a href="<?php echo U('User/sbj',array('userid'=>$v['id']));?>"  style="font-size:12px;cursor:pointer;">编辑 |</a>
														
																<a href="<?php echo U('User/sdel',array('userid'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">删除</a>
															</td>
