...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            ...
            <li class="text-muted">会员抢单意向表</li>
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-size:12px;">会员余额</th>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
															...
															<td style="font-size:12px;">
																<a href="<?php echo U('Roborder/putorder',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">匹配订单 ||</a>
																<a href="<?php echo U('Roborder/delnullorder',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">取消订单</a>
															</td>	
