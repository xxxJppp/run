                                            ...
                                            <div class="form-group right">
												<form class="form" method="get" action="">
                                                 <div style="float:left;width:20%" class="input-group search-form ssssy"> <span style="float:left;height: 34px; ">状态</span>
                                                   <input  type="text" name="zt" class="search-input  " value="<?php echo ($_GET["zt"]); ?>"  placeholder="1:未处理,2:退回,3:成功" style="float: left;width: 88%;"> </div> 
                                       ...
                                       <div style="float:left;" class="input-group search-form ssssy"> <span style="float:left;height: 34px; ">结束日期</span>
                                               ...
                                               <span class="input-group-btn"><a class="btn btn-default search-btn" style="padding:2px;"><i class="fa fa-search"></i></a></span></div>
												<div style="float:left;width:10%;" class="input-group search-form" style="">
                                                    ...
                                                    <input type="submit" value="金额排序" style="border:none;height:33px;width:80%;background:#2699ed;color:#ffffff;cursor:pointer;"/>
                                                </div>
												 </form>
                                            </div>
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-size:12px;">会员ID</th>
                                                    <th style="font-size:12px;">会员账户</th>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                            ...
                                                            <td style="font-size:12px;"><?php echo $v['uid'];?></td>
                                                            <td style="font-size:12px;">

                                                                <?php  $a = M('user')->where(array('userid'=>$v['uid']))->find(); echo $a['account']; ?>
...
<script type="text/javascript">
	...
	function show_sub(v){ 
   if(v=='zt'){
   $('#tips').attr('placeholder','1:未处理,2:退回,3:成功');
   }
   if(v=='date'){
