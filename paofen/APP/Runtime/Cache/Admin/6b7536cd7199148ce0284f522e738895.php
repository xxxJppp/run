            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/Admin/User/ewminfo/id/127.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group item_title ">
											 ...
											 <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="username" readonly="readonly" value="<?php echo ewmskzj($info['id']);?>"/>
                                                </div>
                                            </div>
