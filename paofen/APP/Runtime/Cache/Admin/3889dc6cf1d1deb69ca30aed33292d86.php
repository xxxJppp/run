                                ...
                                <div class="col-xs-12 col-sm-12 clearfix" style="margin-bottom:20px;padding-top:0px;padding-bottom:10px;">
                                            ...
                                            <div class="form-group right">
												<form class="form" method="get" action="">
                                                 ...
                                                 <div style="float:left;width:20%" class="input-group search-form ssssy"> <span style="float:left;height: 34px; ">状态</span>
                                                   <input  type="text" name="zt" class="search-input  " value="<?php echo ($_GET["zt"]); ?>"  placeholder="1:未匹配,2:已匹配,3:成功,4:超时" style="float: left;width: 88%;"> </div> 
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                  ...
                                                  <th style="font-size:12px;">抢单金额</th>
                                                    <th style="font-size:12px;">抢单时间</th>
                                                  	<th style="font-size:12px;">二维码</th>
                                                  <th style="font-size:12px;">凭证</th>
                                                    <th style="font-size:12px;">投诉理由</th>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                          ...
                                                          <td style="font-size:12px;">
                                                              ...
                                                              <a href="<?php echo $v['tspic'];?>" rel="lytebox">查看凭证</a>
                                                              
                                                            </td>
															<td style="font-size:12px;"><?php if($v['ts']<2){echo "收到的钱少了";}else{ echo "收到的钱多了";}?></td>
															<td style="font-size:12px;">
                                                              <?php if($v['status']<3){?>
																<a href="<?php echo U('Roborder/tsadd',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">处理订单</a>
                                                              <?php }else{?>
                                                              <a href="" style="font-size:12px;cursor:pointer;">已解决</a>
                                                              <?php }?>
