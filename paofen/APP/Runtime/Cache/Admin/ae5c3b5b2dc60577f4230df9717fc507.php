...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        <ul class="breadcrumb">
            ...
            <li class="text-muted">代理管理 /  增加代理</li>
            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/Admin/User/adds.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="username" v placeholder="用户名" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="truename"placeholder="真实姓名">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="password" class="form-control input text" name="login_pwd" placeholder="必须填写" >
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="password" class="form-control input text" name="safety_pwd" placeholder="必须填写" >
                                                </div>
                                            </div>
