...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            ...
            <li class="text-muted">会员抢单成功列表</li>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
															...
															<td style="font-size:12px;"><?php echo $v['umoney'];?></td>
                                                          	<td style="font-size:12px;"><?php echo getewminfo2($v['idewm'],2);?></td>
                                                          	<td style="font-size:12px;"><?php echo getewminfo2($v['idewm'],1);?></td>
															<td style="font-size:12px;">
																<?php if($v['class'] ==1){ echo '微信收款'; }elseif($v['class'] ==2){ echo '支付宝收款'; }elseif($v['class'] ==3){ echo '银行收款'; }?>
															</td>
															...
															<td style="font-size:12px;color:red;"><?php if($v['status']==4){echo '超时取消';}?></td>
															
															<td style="font-size:12px;"> 
                                                              	<a href="<?php echo U('Roborder/paypage',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">立即支付(补单) |</a>
