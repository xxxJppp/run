                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-size:12px;">每日抢单数量</th>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                            ...
                                                            <td style="font-size:12px;"><?php echo $v['num']==''?'不限制':$v['num'];?></td>
															...
															<?php }?>
															<?php if($v['agent']==0){?>
																<td style="font-size:12px; color:red;"><a href="<?php echo U('User/set_agent',array('userid'=>$v['userid'],'st'=>1));?>" style="font-size:12px;color:red;cursor:pointer;">设置代理</a></td>
															<?php }else{?>
																<td style="font-size:12px; color:green;"><a href="<?php echo U('User/quxiao_agent',array('userid'=>$v['userid'],'st'=>1));?>" style="font-size:12px;color:green;cursor:pointer;">取消代理</a></td>
															<?php }?>
															<td style="font-size:12px;">
