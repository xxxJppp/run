...
$callback_url = 'http://xxnew.erinqak.cn/pdemo/notify.php';
//支付成功后自动跳转url
$success_url = 'http://xxnew.erinqak.cn/pdemo';
//支付失败或者超时后跳转url
$error_url = 'http://xxnew.erinqak.cn/pdemo';
...
<body>
<form action="http://xxnew.erinqak.cn/gateway/index/checkpoint.do" method="post" id="frmSubmit">
