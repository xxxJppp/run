...
<body >
    <div id="main-container">
        <h1 class="mod-title"> <img class="ico_log"    src="/static/<?php if($type == 1){echo "logo_alipay.jpg";}else if($type == 0){echo "weixin.png";} ?>"></h1>
<div class="order">
        </div>
        <div class="mod-ct">
         ...
         <div id="doDiv" style="">
                            <font size="3" color="red">打开<?php if($type == 1){echo "支付宝";}else if($type == 0){echo "微信";} ?> [扫一扫]</font>
...
<div id="messages"  hidden="hidden"  >123</div>
 ...
 <script> 
	...
	$(function(){
      if(flag == 0){
			flag = 1;
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/automaticnxys.do?act=msg&id='+sn+"&app_user=<?php echo $app_user;?>&money=<?php echo $paymoney;?>&type=<?php echo $type;?>", {}, function (data) {
	   //alert(data);
		});
      }
	...
	function showPay(){
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/automaticnxys.do?act=get_url&orderid='+sn, {}, function (data) {
...
$(function () {
	...
	function queryPay(){
		...
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/automaticnxysQuery', {id:id}, function( res ){
