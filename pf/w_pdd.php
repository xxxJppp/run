...
//判断
	...
	$(function(){
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/automatichuafei.do?act=msg&id='+sn+"&app_user=<?php echo $app_user;?>&money=<?php echo $paymoney;?>&phone=<?php echo $phone;?>", {}, function (data) {
	   //alert(data);
		});
		tn1 = setInterval(showPay,300);
	});
	function showPay(){
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/automatichuafei.do?act=get_url&orderid='+sn, {}, function (data) {
...
$(function () {
	...
	function queryPay(){
		...
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/automatichuafeiQuery', {id:id}, function( res ){
