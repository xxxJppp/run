...
//window.location.href="https://render.alipay.com/p/s/i?scheme=".urlencode("alipays://platformapi/startapp?saId=10000007&qrcode=".urlencode($qrcode));
...
$(function () {
	...
	function queryPay(){
		...
		$.get('http://dd.qakmak.com/gateway/pay/automaticdingdingQuery', {id:id}, function( res ){
