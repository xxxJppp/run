                ...
                <div class="col s12 m12 l12" style="margin-top: 8px;">
                  <div class="row">
                    <form class="col s12" id="from">
                      ...
                      <div class="row">
                         <div class="input-field col s3">
                          <input placeholder="需要提现的金额" id="amount" name="amount" type="text" class="validate" value="100.00">
                          <label>金额</label>
                        </div>
                        <div class="input-field col s4" style="margin-top: 38px;">可提现余额： <b style="color: red;"><?php echo $_SESSION['MEMBER']['balance'];?></b></div>
                      </div>
                       ...
                       <a class="btn waves-effect waves-light teal" onclick="apply();" style="background-color: #5874c8 !important;">确认提现</a></div></div>
