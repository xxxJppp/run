...
<section id="content">
    ...
    <div class="container">
        <div class="section">
            ...
            <p class="caption">
                <a href="<?php echo url::s("mashang/paofen/automaticOrder"); ?>" style="font-size: 14px;"
                   class="btn waves-effect waves-light  cyan darken-2"><i class="mdi-editor-border-all left"
                                                                          style="width: 10px;"></i>全部订单</a>

                <a onclick="addalipay();" style="font-size: 14px;background-color: red;!important;"
                   class="btn waves-effect waves-light  cyan "><i class="mdi-content-add left" style="width: 10px;"></i>添加支付宝固码收款</a>
                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l12">
                        <table class="striped" style="font-size: 14px;">
                            ...
                            <tr>
                                <td>筛选类型 <br>[ <a
                                            href="<?php echo url::s('mashang/paofen/automatic', 'sorting=type&code=go'); ?>">全部</a>
                                    /
                                    <a href="<?php echo url::s('mashang/paofen/automatic', 'sorting=type&code=1'); ?>">支付宝</a>
                                    /
...
<!--                                    <a href="--><?php //echo url::s('mashang/paofen/automatic', 'sorting=type&code=6'); ?><!--">微信店员</a>]-->
                            ...
                            <?php foreach ($result['result'] as $ru) { ?>
                                <tr>
                                    ...
                                    <td>
                                        APP商户号: <?php echo $ru['app_user'] == '0' ? '<span style="color:red;">Unused</span>' : '<span style="color:green;">' . $ru['app_user'] . '</span>'; ?>
                                        [ <a href="#" onclick="edit('<?php echo $ru['id']; ?>');">修改名称</a> ] <font
                                                color=red>( <?php if ($ru['type'] == '1') {
                                                echo "支付宝";
                                            } else if ($ru['type'] == '2') {
                                                echo "微信";
                                            } else if ($ru['type'] == '3') {
                                        ...
                                        <?php if ($ru['type'] == '4') { ?>
                                            支付宝账号: <?php echo $ru['account'] == '0' ? '<span style="color:red;">Unused</span>' : '<span style="color:green;">' . $ru['account'] . '</span>'; ?>
                                            <br>
                                            PID: <?php echo $ru['pid'] == '0' ? '<span style="color:red;">Unused</span>' : '<span style="color:green;">' . $ru['pid'] . '</span>'; ?>
                                        <?php } else if ($ru['type'] == '5') { ?>
                                            姓名：<?php echo $ru['gathering_name'] == '0' ? '<span style="color:red;">Unused</span>' : '<span style="color:green;">' . $ru['gathering_name'] . '</span>'; ?>
                                            <br>
                                            卡号：<?php echo $ru['account_no'] == '0' ? '<span style="color:red;">Unused</span>' : '<span style="color:green;">' . $ru['account_no'] . '</span>'; ?>
                                            <br>
                                            CARDID：<?php echo $ru['cardid'] == '0' ? '<span style="color:red;">Unused</span>' : '<span style="color:green;">' . $ru['cardid'] . '</span>'; ?>
                                            <br>
                                        ...
                                        <br>( <a href="#" onclick="del('<?php echo $ru['id']; ?>');"
                                                 style="color:#757575;">删除账户</a> )
...
<script type="text/javascript">
    ...
    function login_listen(id) {
        listen_login = setInterval(function () {
            $.get("<?php echo url::s('index/paofen/getAutomaticStatus', "id=");?>" + id, function (result) {
                if (result.code > 0) {
