...
<body>
        ...
        <div class="loginBanner clear-a">
            ...
            <div class="loginBanner_content clear-a">
                <div class="loginBanner_text fl">
                    <p class="loginBanner_text_p1"><strong>火山支付</strong><span></span>您的贴身管家</p>
            ...
            <div class="introduce_box">
                    ...
                    <div class="introduce_width">
                        <ul class="clear-a">
                            <li class="introduce2_left">
                                <h5><?php echo WEB_NAME; ?>为您保驾护航</h5>
                ...
                <div class="introduce3">
                    <div class="introduce_width clear-a">
                        <ul>
                            <li><h5>选择<?php echo WEB_NAME; ?>的理由</h5></li>
                            <li>
                ...
                <div class="introduce5">
                    <div class="introduce_width">
                        <ul>
                            ...
                            <li><p>是<?php echo WEB_NAME; ?>的初衷</p></li>
    ...
    <div class="login_foot">
        <div>
            ...
            <p> Copyright 2018-2019 <?php echo WEB_NAME; ?> All Rights Reserved</p>  
        </div>
    </div>

</body>
  
  <script >function tishi(){alert("请联系客服：3823903")}</script>
  <!-- jQuery Library -->
