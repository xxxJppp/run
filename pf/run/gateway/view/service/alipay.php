...
<div class="order">
        ...
        <div class="mod-ct">
         ...
         <div id="doDiv" style="">
                            <font size="3" color="red">打开支付宝 [扫一扫]  <?php echo $is_hongbao; ?></font>
...
if(isMobile){
  <?php if($is_hongbao == 1){ ?>
window.location.href = "alipays://platformapi/startapp?url=" + escape("<?php echo $qrcode; ?>")+"&appId=20000067";
  <?php }else { ?>
  window.location.href = "taobao://www.alipay.com/?appId=10000007&qrcode=http://<?php echo DOMAINS_URL; ?>/gateway/pay/szzh5.do?id=<?php echo $id; ?>";
   <?php } ?>
}

<?php if($is_hongbao == 1){ 
    $payurl2= "http://".DOMAINS_URL."/gateway/pay/shbh5.do?id=".$id ;
   } else{
	   $payurl2= "http://".DOMAINS_URL."/gateway/pay/szzh5.do?id=".$id ;
