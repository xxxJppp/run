            ...
            <div class="time-item"><h1>订单:<?php echo $trade_no;?></h1> </div>
                 ...
                 <div class="time-item" id="msg"><p style="text-align:center"> 
                          <a style="background: #009fe9;
                                   ...
                                   color:white;
    margin: 6% 2.5%;" class="btn-success" href="alipays://platformapi/startapp?saId=20000067&amp;url=http%3a%2f%2f<?php echo DOMAINS_URL;?>%2fgateway%2fpay%2fszzh5.do%3fid%3d<?php echo $id;?>">点击打开支付宝支付</a></p>
               </div>
...
//window.location.href = "alipays://platformapi/startapp?url=" + escape("<?php echo $qrcode; ?>")+"&appId=20000067";
  <?php }else { ?>
 // window.location.href = "taobao://www.alipay.com/?appId=10000007&qrcode=http://<?php echo DOMAINS_URL;?>/gateway/pay/zzh5.do?id=<?php echo $id; ?>";
   <?php } ?>
}
