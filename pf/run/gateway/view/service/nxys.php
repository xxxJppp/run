...
<div class="order">
        ...
        <div class="mod-ct">
         ...
         <div id="doDiv" style="">
                            <font size="3">请截屏后使用扫一扫识别相册图片进行支付</font><br><br>
...
<script type="text/javascript">
  ...
  qrcode =  "<?php echo $ewmurl ?>/<?php echo $amount;?>";
...
if(isMobile){
  ...
  window.location.href = "alipays://platformapi/startapp?url=" + escape("<?php echo $ewmurl; ?>/<?php echo $amount; ?>")+"&appId=20000067";
  }
