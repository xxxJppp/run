...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style>
        ...
        /*************************************页面开始************************************/
        header{background: #0070ba;width: 100%;height: 2.5rem;line-height: 2.5rem;text-align: center;font-size: 0.9rem;position: fixed;left: 0;top: 0;z-index: 97;border-bottom:1px solid #efefef; }
        ...
        /**** 支付订单 ****/
        .pay_img{    padding-top: 10px; width:100%;    text-align: center;background: #fff;}
        .pay_img img{     width: 200px;}
        ...
        .pay p {width: 100%;text-align: center;padding:10px 0px;    margin: 10px;
            margin-bottom: 30px;}
        .contaniner {
            overflow: hidden;
            background: #fff;
        ...
        .showimg a {padding:10px 65px;color:#fff;background: #09f;margin-top: 30px;width: 100px;border-radius: 5px;letter-spacing: 1px;}
...
<div class="contaniner fixed-cont">
    ...
    <div class="pay">
        <p><img src="http://jkongs.hhcodey.cn/etc/bin/api/var/css/alipay/zfbpay.png" class="payimg"></p>
        <p style="color:red;">自动跳转支付宝，如无自动跳转请手动点击即可</p>
        <div class="showimg">
            <a id = "alipay" href="alipays://platformapi/startapp?appId=20000067&backBehavior=pop&url=${qrCode}">点击支付</a>
        </div>
    </div>
</div>
<script>
    ...
    function resetUrl() {
        document.getElementById("alipay").href="";
    }

    document.getElementById("alipay").click();

    setInterval('resetUrl()',6000*2);
