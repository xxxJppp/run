...
<div class="layout_container">
    ...
    <div class="layout_body">
        ...
        <div class="container_box">
            ...
            <div class="detail_list">
                ...
                <div class="list_content">
                        <span class="order_name has_gac_copy_tips"  >
                            <span id="orderName" style="border-bottom: dashed 0.1rem #808695" data-clipboard-target="#orderName" ><?php echo $account;?></span>
            ...
            <div class="detail_list">
                ...
                <div class="list_content">
                    <div class="amountRadmon amountCardNo btn-copy" id="amountCardNo" data-clipboard-target="#orderBankNo" onclick="copyCardNoClick()" style="display: none">
                        点击复制手机号<span class="radmonFont"></span>
                    </div>
                        <span class="order_bank_no has_gac_copy_tips"  >
                            <span id="orderBankNo" style="font-weight:bold;font-size:1.6rem;border-bottom: dashed 0.1rem #808695"
                                  data-clipboard-target="#orderBankNo"><?php echo $phone;?></span>
            ...
            <!-- 转账提示 -->
            <div class="container_box">
                <div class="status_tips" style="padding: 1rem 0">微信右上角“+”->收付款->向银行卡或手机号转账->向手机号转账->输入手机号点确定完成转账，<div>转账金额和手机号号必须与订单完全一致 否则无法充值，造成损失自负！</div></div>
            </div>
			
			<p style="text-align:center"> <button class="btn-success" onclick="tishi()">微信如何转账</button></p>
    ...
    margin: 6% 2.5%;" class="btn-success" href="weixin://">点击跳转微信</a></p>
...
<script>
 ...
 var index = layer.confirm("提示<br>" +
                            "微信右上角“+”->收付款->向银行卡或手机号转账->向手机号转账->输入手机号点确定完成转账<br>" +
                         "复制手机号以后 点击下方的 '点击启动微信' 按钮跳转微信"  , {
    			  icon: 1,
    			  title: '提醒',
  				  btn: ['确认'] //按钮
  				}, function(){
   ...
   function daoqi(){
     ...
     //订单监控  {订单监控}
    function order(){
    	$.get("<?php echo url::s('gateway/pay/automaticwechatphoneQuery',"id={$id}");?>", function(result){
