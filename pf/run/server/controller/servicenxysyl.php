...
class servicenxysyl{
   ...
   public function update(){
    ...
    public function uploadOrder(){
        ...
        file_put_contents("fuwubannxysyllllllll_log.txt", json_encode($_POST));
   ...
   exit;
        ...
        $find_order = $this->mysql->query('service_order',"status=2 and amount={$money} and app_user LIKE '{$appid}'")[0];
        ...
        if (is_array($find_order)) {
            ...
            $result = callbacks::curl('http://'.DOMAINS_URL.'/server/servicenxysyl/callback.do', http_build_query([
                                'orderid' => $order_id,
                                'id' => $service_id
