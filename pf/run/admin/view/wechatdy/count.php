                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <form action="" method="get">
                                    ...
                                    <th>微信店员ID：<input type="text" name="wechatdy_id" value="<?php if(!empty($_GET['wechatdy_id'])){  echo $_GET['wechatdy_id']; }?>"></th>
                            ...
                            <?php foreach ($result['result'] as $ru) { ?>
                                <tr>
                                    <td>微信店员ID：<a
                                                href='<?php echo url::s("admin/wechatdy/automatic", "id={$ru['wechatdy_id']}"); ?>'><?php echo $ru['wechatdy_id']; ?></a>
                         ...
                         <?php echo $ru['wechatdy_id']; ?> | <?php echo $ru['id']; ?>
                                    ...
                                    <td>商户信息：<?php $userInfo = $mysql->query("client_user", "id={$ru['user_id']}")[0];
                                        echo is_array($userInfo) ? '<a href="' . url::s("admin/wechatdy/automaticOrder", "sorting=user&code={$userInfo[id]}&locking=true") . '"><span style="color:green;font-size:14px;font-weight:bold;">' . $userInfo['username'] . '</span></a>' . ' ( 商户ID: ' . $userInfo['id'] . ' ) ' : '<span style="color:red;font-size:8px;">会员不存在</span>'; ?>
                                        <br>手机号码：<span
