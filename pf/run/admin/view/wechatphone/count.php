                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <form action="" method="get">
                                    <th>开始时间: <input type="date" style="width:140px" name="start_time" value="<?php if(!empty($_GET['start_time'])){  echo $_GET['start_time']; }  ?>"></th>
                                    <th>结束时间： <input type="date" style="width:140px" name="end_time" value="<?php if(!empty($_GET['end_time'])){  echo $_GET['end_time']; } ?>"></th>
                                    <th>微信转手机ID：<input type="text" name="wechatphone_id" value="<?php if(!empty($_GET['wechatphone_id'])){  echo $_GET['wechatphone_id']; }?>"></th>
                            ...
                            <?php foreach ($result['result'] as $ru) { ?>
                                <tr>
                                    <td>微信转手机ID：<a
                                                href='<?php echo url::s("admin/wechatphone/automatic", "id={$ru['wechatphone_id']}"); ?>'><?php echo $ru['wechatphone_id']; ?></a>
                         ...
                         <?php echo $ru['wechatphone_id']; ?> | <?php echo $ru['id']; ?>
                                    ...
                                    <td>商户信息：<?php $userInfo = $mysql->query("client_user", "id={$ru['user_id']}")[0];
                                        echo is_array($userInfo) ? '<a href="' . url::s("admin/wechatphone/automaticOrder", "sorting=user&code={$userInfo[id]}&locking=true") . '"><span style="color:green;font-size:14px;font-weight:bold;">' . $userInfo['username'] . '</span></a>' . ' ( 商户ID: ' . $userInfo['id'] . ' ) ' : '<span style="color:red;font-size:8px;">会员不存在</span>'; ?>
                                        <br>手机号码：<span
