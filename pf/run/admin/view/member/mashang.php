                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a data-toggle="modal" data-target="#add1" class="btn btn-light">添加码商</a>
                    ...
                    <table class="layui-table" lay-data="{width:'100%',limit:15,id:'userData'}">
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'realname', width:140}">姓名</th>
                        ...
                        <?php foreach ($member['result'] as $em) { ?>
                            <tr id="user_<?php echo $em['id']; ?>">
                                ...
                                <td style="text-align:center; color:#666">
                                    ...
                                    $order = $mysql->select("select count(id) as count,sum(amount) as amount from {$fix}mashang_huoli_log where uid = {$em['id']} and time > {$nowTime}  ");
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-line" name="realname"  placeholder="姓名">
                            </div>
                        </div>
