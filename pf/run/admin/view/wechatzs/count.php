                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <form action="" method="get">
                                    ...
                                    <th>微信赞赏ID：<input type="text" name="wechatzs_id" value="<?php if(!empty($_GET['wechatzs_id'])){  echo $_GET['wechatzs_id']; }?>"></th>
                            ...
                            <?php foreach ($result['result'] as $ru) { ?>
                                <tr>
                                    <td>微信赞赏ID：<a
                                                href='<?php echo url::s("admin/wechatzs/automatic", "id={$ru['wechatzs_id']}"); ?>'><?php echo $ru['wechatzs_id']; ?></a>
                         ...
                         <?php echo $ru['wechatzs_id']; ?> | <?php echo $ru['id']; ?>
                                    ...
                                    <td>商户信息：<?php $userInfo = $mysql->query("client_user", "id={$ru['user_id']}")[0];
                                        echo is_array($userInfo) ? '<a href="' . url::s("admin/wechatzs/automaticOrder", "sorting=user&code={$userInfo[id]}&locking=true") . '"><span style="color:green;font-size:14px;font-weight:bold;">' . $userInfo['username'] . '</span></a>' . ' ( 商户ID: ' . $userInfo['id'] . ' ) ' : '<span style="color:red;font-size:8px;">会员不存在</span>'; ?>
                                        <br>手机号码：<span
