  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
		 ...
		 <button type="button" onclick="addzhuanzhang();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增支付宝转账</button>
             <button type="button" onclick="addhongbao();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增支付宝红包</button>
             <button type="button" onclick="addbank();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增支付宝转银行卡</button>
              <button type="button" onclick="addyunshanfu();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增云闪付</button>
              <button type="button" onclick="addlakala();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增拉卡拉</button>
            <button type="button" onclick="addnxwx();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增农信微信支付宝</button>
            <button type="button" onclick="addnxyl();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增农信银联</button>
                       <button type="button" onclick="addwechatdy();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增微信店员模式</button>
                       <button type="button" onclick="addwechatsj();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增微信商户模式</button>
                       <button type="button" onclick="addwechatbank();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增微信转卡</button>
                       <button type="button" onclick="addpdd();" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新增拼多多固码</button>
        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            <thead>
              <tr>
  <td>设备信息  <br>[ <a href="<?php echo url::s('admin/service/index','sorting=type&code=go');?>">全部</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=1');?>">微信</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=2');?>">支付宝</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=3');?>">银行卡账号</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=4');?>">拉卡拉</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=5');?>">云闪付</a>  / <a href="<?php echo url::s('admin/service/index','sorting=type&code=6');?>">农信微信支付宝</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=9');?>">微信店员</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=10');?>">微信商户</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=11');?>">微信转卡</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=12');?>">拼多多固码</a> / <a href="<?php echo url::s('admin/service/index','sorting=type&code=13');?>">支付宝固码</a>]</td>
         ...
         function editMaxdd(id){
          ...
          $('.showSweetAlert fieldset input').attr('type','hidden');
            ...
            swal({   title: "请输入拉卡拉配置信息",
                  ...
                  closeOnConfirm: false,
                  html: true,
                  text: "拉卡拉收款码链接（<a href='https://jiema.wwei.cn/' target='_blank'>点击这里解析二维码</a>）<input type='text' id='ewmurl' value=''>"
                  +"备注<input type='text' id='name' value=''>",
                  confirmButtonText: "提交" },
              function(inputValue){
                  if (inputValue === false) return false;
