...
<div class="container-padding">
  ...
  <div class="row">
    ...
    font-size: 14px;" type="submit" value="查询"></th>
              ...
              <tr>
                <td>服务信息 [ <a href="<?php echo url::s('admin/service/order','sorting=type&code=go');?>">全部</a> / <a href="<?php echo url::s('admin/service/order','sorting=type&code=1');?>">微信</a> / <a href="<?php echo url::s('admin/service/order','sorting=type&code=2');?>">支付宝</a> / <a href="<?php echo url::s('admin/service/order','sorting=type&code=3');?>">银行卡转账</a>  / <a href="<?php echo url::s('admin/service/order','sorting=type&code=4');?>">拉卡拉</a> / <a href="<?php echo url::s('admin/service/order','sorting=type&code=5');?>">云闪付</a> / <a href="<?php echo url::s('admin/service/order','sorting=type&code=6');?>">农信微信支付宝</a> / <a href="<?php echo url::s('admin/service/order','sorting=type&code=8');?>">农信银联</a> / <a href="<?php echo url::s('admin/service/order','sorting=type&code=9');?>">微信店员</a> / <a href="<?php echo url::s('admin/service/order','sorting=type&code=10');?>">微信商户</a>/ <a href="<?php echo url::s('admin/service/order','sorting=type&code=11');?>">微信转卡</a>/ <a href="<?php echo url::s('admin/service/order','sorting=type&code=12');?>">拼多多固码</a>/ <a href="<?php echo url::s('admin/service/order','sorting=type&code=13');?>">支付宝固码</a>]</td>
