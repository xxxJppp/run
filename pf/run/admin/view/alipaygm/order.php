        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <?php  foreach ($result['result'] as $ru){?>
              <tr>
                <td>支付宝ID：<a href='<?php echo url::s("admin/alipaygm/automatic","id={$ru['alipaygm_id']}");?>'><?php echo $ru['alipaygm_id'];?></a> / 订单ID：<?php echo $ru['id'];?> ( <a target="_blank" href="<?php echo url::s('gateway/pay/automaticalipaygm',"id={$ru['id']}");?>">支付链接</a> )
