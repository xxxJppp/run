    ...
    public function costCogResult(){
     // $this->check();
      ...
      $wechatsj_auto_open = request::filter('post.wechatsj_auto_open','','htmlspecialchars') == 1 ? 1 : 2;
        ...
        $huafei_auto_open = request::filter('post.huafei_auto_open','','htmlspecialchars') == 1 ? 1 : 2;
      
       $wechatphone_auto_open = request::filter('post.wechatphone_auto_open','','htmlspecialchars') == 1 ? 1 : 2;
      
        $wechatzs_auto_open = request::filter('post.wechatzs_auto_open','','htmlspecialchars') == 1 ? 1 : 2;
        //--
        ...
        $paofen_auto = request::filter('post.paofen_auto','','htmlspecialchars') == 1 ? 1 : 2;
        //--
        ...
        $costCog = [
          ...
          'wechatphone_auto'=>[
                'open'=>$wechatphone_auto_open
            ],
           'wechatzs_auto'=>[
                'open'=>$wechatzs_auto_open
            ],
            'huafei_auto'=>[
                'open'=>$huafei_auto_open
            ]
        ];
