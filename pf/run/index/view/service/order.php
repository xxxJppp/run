...
?>
                  ...
                  <div class="input-field col s6" style="font-weight:normal;width:100%;">
                    <select multiple id="service" >
                      ...
                      <?php }?>
                        ...
                        <th>回调信息 [ 回调测试: <a href="#" onclick="robinTest(1);">微信</a> / <a href="#" onclick="robinTest(2);">支付宝</a>  / <a href="#" onclick="robinTest(3);">银行转账</a> / <a href="#" onclick="robinTest(4);">拉卡拉</a> / <a href="#" onclick="robinTest(5);">云闪付</a>/ <a href="#" onclick="robinTest(6);">农信微信支付宝</a>/ <a href="#" onclick="robinTest(8);">农信银联</a> / <a href="#" onclick="robinTest(9);">微信店员</a> / <a href="#" onclick="robinTest(10);">微信商户</a>/ <a href="#" onclick="robinTest(11);">微信转卡</a> / <a href="#" onclick="robinTest(12);">拼多多固码</a> / <a href="#" onclick="robinTest(13);">支付宝固码</a>]</th>
            
                                        <label> [ <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=all");?>">全部</a> / <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=wechat");?>">微信</a> / <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=alipay");?>">支付宝</a>/ <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=bank");?>">银行转账</a>/ <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=lakala");?>">拉卡拉</a> / <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=yunshanfu");?>">云闪付</a>/ <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=nxyswx");?>">农信微信支付宝</a>/  <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=nxysyl");?>">农信银联</a> /  <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=wechatdy");?>">微信店员</a> /  <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=wechatsj");?>">微信商户</a>/  <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=wechatbank");?>">微信转卡</a> /  <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=pddgm");?>">拼多多固码</a> /  <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=alipaygm");?>">支付宝固码</a>] <?php if ($_SESSION['SERVICE']['ORDER']['WHERE'] == ''){?>(<a href="#" onclick="service();">开始查询</a>)<?php }else{?>(<a href="<?php echo url::s('index/service/order',"sorting=service&code=closed");?>">取消</a>)<?php }?></label>
    ...
    font-size: 14px;" onclick="exportData()">
                    ...
                    <?php foreach ($result['result'] as $ru){?>
                      <tr>
                        <td>支付类型：<?php if ($ru['types'] == 1) echo '<span style="color:green;">微信</span>';else if ($ru['types'] == 2) echo '<span style="color:red;">支付宝</span>';else if ($ru['types'] == 3) echo '<span style="color:red;">银行卡转账</span>' ;else if ($ru['types'] == 4) echo '<span style="color:red;">拉卡拉</span>'; else if ($ru['types'] == 5) echo '<span style="color:red;">云闪付</span>';else if ($ru['types'] == 6) echo '<span style="color:red;">农信微信支付宝</span>';else if ($ru['types'] == 8) echo '<span style="color:red;">农信银联</span>';else if ($ru['types'] == 9) echo '<span style="color:red;">微信店员</span>';else if ($ru['types'] == 10) echo '<span style="color:red;">微信商户</span>';else if ($ru['types'] == 11) echo '<span style="color:red;">微信转卡</span>';else if ($ru['types'] == 12) echo '<span style="color:red;">拼多多固码</span>';else if ($ru['types'] == 13) echo '<span style="color:red;">支付宝固码</span>' ?> / 订单ID：<?php echo $ru['id'];?> ( <a target="_blank" href="<?php echo url::s('gateway/pay/service',"id={$ru['id']}");?>">支付链接</a> )
