	...
	<div class="login-wp">
		...
		<div class="login-bd">
			...
			<ul>
              ...
              <li>
					<input type="text" class="txt" name="recommend_username" id="text" maxlength="30"   readonly="readonly"   placeholder="推荐人会员名,选填" value="<?php if(!empty($_GET['username'])){  echo $_GET['username']; } ?>" />
				</li>
