...
<form action="<?php echo url::s('gateway/index/checkpoint');?>" method="post" id="frmSubmit">
	...
	<input type="hidden" name="thoroughfare" value="wechatsj_auto"/>
	...
	<input type="hidden" name="success_url" value="<?php echo url::s('index/wechatsj/automatic');?>" />
	<input type="hidden" name="error_url" value="<?php echo url::s('index/wechatsj/automatic');?>" />
	<input type="hidden" name="amount" value="<?php echo floatval($_GET['amount'].mt_rand(0.01,0.99));?>" />
</form>
