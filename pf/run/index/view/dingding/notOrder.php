...
<section id="content">
    ...
    <div class="container">
        <div class="section">
            ...
            <p class="caption">
                <a href="<?php echo url::s("index/dingding/automatic"); ?>" style="font-size: 14px;" class="btn waves-effect waves-light  cyan darken-2"><i class="mdi-editor-border-all left" style="width: 10px;"></i>无匹配订单列表</a>
            </p>
                    ...
                    <div class="col s12 m12 l12">
                        <table class="striped" style="font-size: 14px;">
                            ...
                            <?php foreach ($result as $k=>$ru) { ?>
                                <tr>
                                    <td>银行卡账号：<a href='<?php echo url::s("index/dingding/automatic"); ?>'><?php echo $ru['dingding_acount']; ?></a></td>
...
<script type="text/javascript">
    ...
    function reissue(id) {
        swal({
            ...
            function () {
                //开始请求支付宝登录
                $.get("<?php echo url::s('index/dingding/notOrderReissue', "id=");?>" + id, function (result) {
                    if (result.code == '200') {
    ...
    function trade_no(obj) {
        location.href = "<?php echo url::s('index/dingding/notOrder', "sorting=trade_no&code=");?>" + $(obj).val();
    }

    function alipay() {
        var alipay = $('#alipay').val();
        location.href = "<?php echo url::s('index/dingding/notOrder', "sorting=alipay&code=");?>" + alipay;
