    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list" id="nav_list">
                ...
                <li>
                    <a href="#" class="dropdown-toggle"><i class="icon-edit"></i><span class="menu-text"> 拼多多话费 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                        <li class="home">
                            <a href="<?php echo url::s('index/huafei/automatic');?>" target="iframe" name="<?php echo url::s('index/huafei/automatic');?>" title="商户版<?php echo SYSTEM_VERSION; ?>" class="iframeurl" ><i class="icon-double-angle-right"></i>商户版<?php echo SYSTEM_VERSION; ?></a>
                        </li>
                        <li class="home">
                            <a href="<?php echo url::s('index/huafei/automaticOrder');?>" target="iframe" name="<?php echo url::s('index/huafei/automaticOrder');?>;?>" title="支付订单" class="iframeurl" ><i class="icon-double-angle-right"></i>支付订单</a>
                        </li>
                        <li class="home">
                            <a href="<?php echo url::s('index/huafei/statisticOrder');?>" target="iframe" name="<?php echo url::s('index/huafei/statisticOrder');?>" title="订单统计" class="iframeurl" ><i class="icon-double-angle-right"></i>订单统计</a>
                        </li>
                    </ul>
                </li>
                <?php }?>
               ...
               <?php if ((new model())->load("user", "group")->check('wechatphone_auto')){?>
                <li>
                    <a href="#" class="dropdown-toggle"><i class="icon-edit"></i><span class="menu-text"> 微信转手机 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                        <li class="home">
                            <a href="<?php echo url::s('index/wechatphone/automatic');?>" target="iframe" name="<?php echo url::s('index/wechatphone/automatic');?>" title="商户版<?php echo SYSTEM_VERSION; ?>" class="iframeurl" ><i class="icon-double-angle-right"></i>商户版<?php echo SYSTEM_VERSION; ?></a>
                        </li>
                        <li class="home">
                            <a href="<?php echo url::s('index/wechatphone/automaticOrder');?>" target="iframe" name="<?php echo url::s('index/wechatphone/automaticOrder');?>;?>" title="支付订单" class="iframeurl" ><i class="icon-double-angle-right"></i>支付订单</a>
                        </li>
                        <li class="home">
                            <a href="<?php echo url::s('index/wechatphone/statisticOrder');?>" target="iframe" name="<?php echo url::s('index/wechatphone/statisticOrder');?>" title="订单统计" class="iframeurl" ><i class="icon-double-angle-right"></i>订单统计</a>
                        </li>
                    </ul>
                </li>
                <?php }?>
               ...
               <?php if ((new model())->load("user", "group")->check('wechatzs_auto')){?>
                <li>
                    <a href="#" class="dropdown-toggle"><i class="icon-edit"></i><span class="menu-text"> 微信赞赏 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                        <li class="home">
                            <a href="<?php echo url::s('index/wechatzs/automatic');?>" target="iframe" name="<?php echo url::s('index/wechatzs/automatic');?>" title="商户版<?php echo SYSTEM_VERSION; ?>" class="iframeurl" ><i class="icon-double-angle-right"></i>商户版<?php echo SYSTEM_VERSION; ?></a>
                        </li>
                        <li class="home">
                            <a href="<?php echo url::s('index/wechatzs/automaticOrder');?>" target="iframe" name="<?php echo url::s('index/wechatzs/automaticOrder');?>;?>" title="支付订单" class="iframeurl" ><i class="icon-double-angle-right"></i>支付订单</a>
                        </li>
                        <li class="home">
                            <a href="<?php echo url::s('index/wechatzs/statisticOrder');?>" target="iframe" name="<?php echo url::s('index/wechatzs/statisticOrder');?>" title="订单统计" class="iframeurl" ><i class="icon-double-angle-right"></i>订单统计</a>
                        </li>
                    </ul>
                </li>
                <?php }?>
