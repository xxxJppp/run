...
<form action="<?php echo url::s('gateway/index/checkpoint');?>" method="post" id="frmSubmit">
	...
	<input type="hidden" name="thoroughfare" value="bank_auto"/>
	...
	<input type="hidden" name="success_url" value="<?php echo url::s('index/bank/automatic');?>" />
	<input type="hidden" name="error_url" value="<?php echo url::s('index/bank/automatic');?>" />
