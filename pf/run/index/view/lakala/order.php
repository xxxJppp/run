            ...
            <p class="caption">
                ...
                <span style="font-size: 15px;margin-left:20px;">[ <b>今日收入:</b> <?php //查询今日收入
                    ...
                    ?>
                        ...
                        <a href="<?php echo url::s("admin/lakala/automaticOrder", "sorting=user&code={$_GET['code']}&locking=true"); ?>"
                           style="color: green;">锁定该用户查询</a> ]<?php } ?> <?php if ($_SESSION['ALIPAY']['WHERE'] != '') { ?>  [
                        <a href="<?php echo url::s("admin/lakala/automaticOrder", "sorting=user&code={$_GET['code']}&locking=false"); ?>"
                    ...
                    <div class="col s12 m12 l12">
                        ...
                        font-size: 14px;" type="submit" value="查询"></th>
                                ...
                                <th>
                                    ...
                                    <div class="input-field col s6" style="font-weight:normal;width:100%;">
                                        <select multiple id="alipay">
                                            <option value="" disabled selected>选择拉卡拉账号</option>
                            ...
                            <?php foreach ($result['result'] as $ru) { ?>
                                <tr>
                                    <td>拉卡拉账号ID：<a
                                                href='<?php echo url::s("index/lakala/automatic"); ?>'><?php echo $ru['lakala_id']; ?></a>
                            ...
                            <?php echo $ru['lakala_id']; ?> | <?php echo $ru['id']; ?> </span>
...
<script type="text/javascript">
    ...
    function trade_no(obj) {
        location.href = "<?php echo url::s('index/lakala/automaticOrder', "sorting=trade_no&code=");?>" + $(obj).val();
    }

    function alipay() {
        var alipay = $('#alipay').val();
        location.href = "<?php echo url::s('index/lakala/automaticOrder', "sorting=alipay&code=");?>" + alipay;
