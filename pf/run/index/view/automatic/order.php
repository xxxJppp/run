              ...
              <div class="row">
                ...
                <div class="col s12 m12 l12">
                  ...
                  <div class="input-field col s6" style="font-weight:normal;">
                    ...
                    <label>选择通道来查看<?php if ($_SESSION['WECHAT']['ORDER']['WHERE'] == ''){?>(<a href="#" onclick="wechat();">开始查询</a>)<?php }else{?>(<a href="<?php echo url::s('index/wechat/automaticOrder',"sorting=wechat&locking=closed");?>">取消锁定</a>)<?php }?>
                    </label>
                  </div>
                        ...
                        <th>支付信息 <?php if ($sorting['code'] != 0 && $sorting['name'] == 'status'){?>(<?php if ($sorting['code'] == 1) echo '获取订单中';if ($sorting['code'] == 2) echo '未支付';if ($sorting['code'] == 3) echo '订单超时';if ($sorting['code'] == 4) echo '已支付';?>)<?php }?><a href='<?php echo url::s('index/wechat/automaticOrder',"sorting=status&code=".($sorting['code']+1));?>'><i class="mdi-image-healing"></i></a></th>
                        <th>异步通知 <?php if ($sorting['code'] != -1 && $sorting['name'] == 'callback'){?>(<?php if ($_GET['code'] == 0) echo '未回调';if ($_GET['code'] == 1) echo '已回调';?>)<?php }?><a href='<?php echo url::s('index/wechat/automaticOrder',"sorting=callback&code=".($sorting['code']+1));?>'><i class="mdi-image-healing"></i></a></th>
                        <th>回调信息</th>
                        <th></th>
                      </tr>
                    </thead>
