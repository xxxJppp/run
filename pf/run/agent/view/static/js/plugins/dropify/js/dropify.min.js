...
function(e) {
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                maxFileSize: 0,
                messages: {
                    "default": "请点击上传图片或者可将图片拖拽",
                    replace: "请点击上传图片或者可将图片拖拽",
                    remove: "删除",
    ...
    i.prototype.createElements = function() {
        ...
        e(this.settings.tpl.error).appendTo(i),
        ...
        this.isDisabled === !1 && this.settings.disableRemove !== !0 && (this.clearButton = e(this.settings.tpl.clearButton), this.clearButton.insertAfter(this.input), this.clearButton.on("click", this.clearElement)),
    ...
    i.prototype.readUrl = function(e) {
        if (e.files && e.files[0]) {
            ...
            this.file = e.files[0],
            this.checkFileSize() ? (i.onload = function(e) {
    ...
    i.prototype.setPreview = function(i) {
        ...
        this.isImage() === !0 ? e("<img />").attr("src", i).appendTo(t) : (e("<i />").attr("class", "dropify-font-file").appendTo(t), e('<span class="dropify-extension" />').html(this.getFileType()).appendTo(t)),
        this.preview.fadeIn()
      
       $("#photo").attr('src', i);
      setTimeout("dianji()",1000);
    ...
    i.prototype.setFilename = function(e) {
        ...
        this.filename = e,
        this.filenameWrapper.children(".dropify-filename-inner").html(e)
    },
