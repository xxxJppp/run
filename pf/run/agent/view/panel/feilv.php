            ...
            <div class="ibox-content">
               ...
               <form class="layui-form"  id="profile">
                   ...
                   <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label" style="width: auto;padding: 4px; margin-top: 5px;">跑分：</label>
                        <div class="layui-input-block" style="margin-left: 0px;width: 30%;float: left;">
                            <input type="text" lay-verify="title" autocomplete="off"
                                  name="paofen_auto"  placeholder="请设置费率" class="layui-input" value="<?php echo $result['paofen_auto'];?>">
                        </div>
