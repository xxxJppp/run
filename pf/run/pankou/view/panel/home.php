...
<title><?php echo WEB_NAME; ?>-  盘口管理 </title>
  <!--[if lt IE 9]>
...
<div class=" zuy-header">
  <nav class="navbar navbar-static-top" role="navigation" >
    ...
    <ul class="nav navbar-top-links navbar-right">
      ...
      <li class="dropdown hidden-xs"> <a  href="/pankou/member/logout.do" class="right-sidebar-toggle"
...
<div id="wrapper">
  ...
  <nav class="navbar-default navbar-static-side" role="navigation">
    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
               <a href="/pankou/panel/home.do"> <i class="fa fa-home"></i>
                ...
                <ul class="nav nav-second-level">
                    <li><a href="/pankou/panel/order" class="J_menuItem"><span class="nav-label">已支付订单</span></a>
                    </li>
                   
                    <li><a href="/pankou/panel/orderweifu" class="J_menuItem"><span class="nav-label">未支付订单</span></a>
                    </li>
                  
                    <li><a href="/pankou/panel/pankouhuoli" class="J_menuItem"><span class="nav-label">订单日志</span></a>
                    </li>
            ...
            <li><a href="#"> <i class="fa fa fa-user"></i> 
              <span class="nav-label">账户管理</span> <span class="fa arrow"></span> </a>
                ...
                <ul class="nav nav-second-level">
                    <li><a href="/pankou/member/edit" class="J_menuItem"><span class="nav-label">修改资料</span></a> </li>
                    <li><a href="/pankou/member/withdraw" class="J_menuItem"><span class="nav-label">我的提现</span></a> </li>
                </ul>
            </li>
            ...
            <li><a href="#"> <i class="fa fa fa-bank"></i> <span class="nav-label">API管理</span> <span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
                    <li><a href="/pankou/doc/home" class="J_menuItem"><span class="nav-label">对接文档</span> </a>  </li>
  ...
  <div id="page-wrapper" class="gray-bg dashbard-1">
    <div class="row J_mainContent" id="content-main">
      <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/pankou/panel/index.do"
