...
<div id="messages"  hidden="hidden"  >123</div>
 ...
 <script> 
	...
	$(function(){
      if(flag == 0){
			flag = 1;
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/automaticyunshanfu.do?act=msg&id='+sn+"&app_user=<?php echo $app_user;?>&money=<?php echo $paymoney;?>", {}, function (data) {
	   //alert(data);
		});
      }
	...
	function showPay(){
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/automaticyunshanfu.do?act=get_url&orderid='+sn, {}, function (data) {
...
$(function () {
	...
	function queryPay(){
		...
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/automaticyunshanfuQuery', {id:id}, function( res ){
