...
$callback_url = 'http://xx.qakmak.com/demo/notify.php';
//支付成功后自动跳转url
$success_url = 'http://xx.qakmak.com/demo2';
//支付失败或者超时后跳转url
$error_url = 'http://xx.qakmak.com/demo2';
...
<body>
<form action="http://xx.qakmak.com/gateway/index/checkpoint.do" method="post" id="frmSubmit">
