...
<body >
    <div id="main-container">
        <h1 class="mod-title"> <img class="ico_log" style="height:60px;"   src="/static/yunshanfu.png"> </h1>
<div class="order">
        </div>
        <div class="mod-ct">
         ...
         <div id="doDiv" style="">
                            <font size="3" color="red">请用云闪付APP来扫码支付，手机上支付时截屏识别二维码</font>
         ...
         <div id="doDiv" style="">
                            <font size="3" color="red">打开云闪付 [扫一扫]</font>
 ...
 <script> 
   ...
   var flag = 0;
	...
	$(function(){
      if(flag == 0){
			flag = 1;
		$.get('http://<?php echo DOMAINS_URL;?>/gateway/pay/service.do?act=msg&id='+id+"&app_user=<?php echo $app_user;?>&money=<?php echo $amount;?>", {}, function (data) {
         //alert(data);
		}); 
      }
