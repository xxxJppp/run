...
$callback_url = 'http://xx.erinqak.cn/demo3/notify.php';
//支付成功后自动跳转url
$success_url = 'http://xxt.erinqak.cn/demo3';
//支付失败或者超时后跳转url
$error_url = 'http://xxt.erinqak.cn/demo3';
...
<body>
<form action="http://xx.erinqak.cn/gateway/index/checkpoint.do" method="post" id="frmSubmit">
