...
<form action="gateway.php" method="post" autocomplete="off" id="from">
    ...
    <div class="w1080 order-amount12" style="border-radius: 1em;height: 11rem;">
        ...
        <div class="order-amount12-right">
            ...
            <p class="l">商户账号：<input type="text" value="10095" name="shid"></p>
            <p class="l">商户秘钥：<input type="text" value="B83205253588C1" name="key"></p>
            <p class="l">商户回调地址： <input type="text" name="url" value="http://xin.com/demo/notify.php"></p>
        </div>
    </div>
    <!--订单号-->
    ...
    <div class="w1080 PayMethod12" style="border-radius: 1em;">
        <div class="row">
            ...
            <ul id="zfs">
                ...
                <input type="hidden" name="pay" value="1" id="pay">
            </ul>
        </div>
    </div>
    <!--立即支付-->
