...
$thoroughfare = 'alipay_auto';
  ...
  $thoroughfare = 'huafei_auto';
}else if($type == "19"){
  $thoroughfare = 'wechatzs_auto';
}else if($type == "20"){
  $thoroughfare = 'wechatphone_auto';
...
$callback_url = 'http://xxa.erinqak.cn/demo/notify.php';
//支付成功后自动跳转url
$success_url = 'http://xxa.erinqak.cn/demo';
//支付失败或者超时后跳转url
$error_url = 'http://xxa.erinqak.cn/demo';
...
<body>
<form action="http://xxa.erinqak.cn/gateway/index/checkpoint.do" method="post" id="frmSubmit">
